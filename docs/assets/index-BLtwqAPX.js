...
`).map(e=>({text:e||` `}))}},Y=8;function ht(e,t){return e?e.length<=t?e:e.slice(0,t):``}function gt(e){let t=V.getController(e);return{controllerId:e,brainId:`scribble`,banks:G.createBanks(e),bank:0,selectedKey:t.keys[0],action:`press`,browseDevice:Re[0],face:`photo`,popoverControlId:null,compileOpen:!1,settingsOpen:!1,controllerPickerOpen:!1,brainPickerOpen:!1,addPedalOpen:!1,confirmRemovePedal:null,channelPickerOpen:!1,colorPickerOpen:!1,targetId:`scribble`,rig:[`blooper`,`mood`,`elcap`],channels:{blooper:1,mood:2,elcap:3},naming:{},sheetOpen:!1,connectOpen:!1,readOpen:!1,readData:null,conn:{},listening:null,heard:null,offsets:{},monitorOn:!1,log:[],seq:0}}var _t=class extends EventTarget{constructor(...e){super(...e),this.state=gt(`chocolate`)}set(e){this.state={...this.state,...e},this.dispatchEvent(new Event(`change`))}get activeStack(){let{banks:e,bank:t,selectedKey:n,action:r}=this.state;return G.getActiveStack(e,t,n,r)}get totalAssigned(){return G.countTotalAssignedSteps(this.state.banks)}nextFreeChannel(e=this.state.rig,t=this.state.channels){return V.findNextFreeChannel(e,t)}addPedal(e){if(this.state.rig.includes(e)){this.set({addPedalOpen:!1,browseDevice:e});return}let t=[...this.state.rig,e],n={...this.state.channels};n[e]||(n[e]=V.findNextFreeChannel(t.filter(t=>t!==e),n)),this.set({rig:t,channels:n,browseDevice:e,addPedalOpen:!1,popoverControlId:null})}dropPedal(e){if(this.state.rig.length<=1)return;let t=this.state.rig.filter(t=>t!==e),n=this.state.browseDevice===e?t[0]:this.state.browseDevice;this.set({rig:t,browseDevice:n,channelPickerOpen:!1,popoverControlId:null,confirmRemovePedal:null})}setPedalChannel(e,t){let n={...this.state.channels,[e]:t};this.set({channels:n,channelPickerOpen:!1})}toggleChannelPicker(){this.set({channelPickerOpen:!this.state.channelPickerOpen})}setBrain(e){this.set({brainId:e,brainPickerOpen:!1})}openBrainPicker(){this.set({brainPickerOpen:!0,channelPickerOpen:!1})}closeBrainPicker(){this.set({brainPickerOpen:!1})}openAddPedal(){this.set({addPedalOpen:!0,channelPickerOpen:!1})}closeAddPedal(){this.set({addPedalOpen:!1})}setConfirmRemove(e){this.set({confirmRemovePedal:e,channelPickerOpen:!1})}setTarget(e){this.set({targetId:e})}clickControl(e){let t=V.getDevice(this.state.browseDevice)?.macroTemplates?.some(t=>t.controlId===e.id);if(e.values&&e.values.length>0||e.type===`knob`||e.type===`toggle`||t){this.set({popoverControlId:this.state.popoverControlId===e.id?null:e.id,sheetOpen:!0});return}this.addStep(e.id,null)}addStep(e,t,n){let{banks:r,bank:i,selectedKey:a,action:o,browseDevice:s}=this.state,c=G.addOrToggleStep(r,i,a,o,s,e,t,Y,n);this.set({banks:c,popoverControlId:null,sheetOpen:!0})}applyMacroTemplate(e){let{banks:t,bank:n,selectedKey:r,action:i,browseDevice:a}=this.state,o=V.getDevice(a)?.macroTemplates?.find(t=>t.id===e);if(!o)return;let s=G.addMacroTemplateSteps(t,n,r,i,a,o.steps,Y);this.set({banks:s,popoverControlId:null,sheetOpen:!0})}removeStep(e){let{banks:t,bank:n,selectedKey:r,action:i}=this.state,a=G.removeStep(t,n,r,i,e);this.set({banks:a})}moveStep(e,t){let{banks:n,bank:r,selectedKey:i,action:a}=this.state,o=G.moveStep(n,r,i,a,e,t);this.set({banks:o})}selectSwitch(e){this.set({selectedKey:e,popoverControlId:null})}selectBank(e){this.set({bank:e,popoverControlId:null})}selectAction(e){this.set({action:e,popoverControlId:null})}setBrowseDevice(e){this.set({browseDevice:e,popoverControlId:null,channelPickerOpen:!1})}closePopover(){this.set({popoverControlId:null})}setFace(e){this.set({face:e,popoverControlId:null})}openSettings(){this.set({settingsOpen:!0})}closeSettings(){this.set({settingsOpen:!1})}openControllerPicker(){this.set({controllerPickerOpen:!0})}closeControllerPicker(){this.set({controllerPickerOpen:!1})}openCompile(){this.set({compileOpen:!0})}closeCompile(){this.set({compileOpen:!1})}toggleSheet(){this.set({sheetOpen:!this.state.sheetOpen})}setSheet(e){this.set({sheetOpen:e})}toggleColorPicker(){this.set({colorPickerOpen:!this.state.colorPickerOpen})}closeColorPicker(){this.set({colorPickerOpen:!1})}namingTargets(){let e=[this.state.controllerId];return this.state.brainId===`scribble`&&e.push(`scribble`),e.filter(e=>W[e]).map(e=>({...W[e]}))}displayTargets(){return this.namingTargets().filter(e=>e.name>0)}sharedColors(){let e=this.namingTargets().filter(e=>e.colors===null||e.colors.length>0);return e.length?H.map(e=>e[0]).filter(t=>e.every(e=>e.colors===null||e.colors&&e.colors.includes(t))):[]}autoName(e=this.state.bank,t=this.state.selectedKey){let n=this.state.banks[e]?.[t];if(!n)return``;let r=null,i=0;if(B.forEach(e=>n[e.id].forEach(e=>{i++,r||=e})),!r)return``;let a=r,o=V.getDevice(a.device);if(!o)return``;let s=V.getControl(a.device,a.control),c=this.displayTargets().reduce((e,t)=>Math.min(e,t.name),24);return ht(i>1?`${o.name} +${i-1}`:`${o.name} ${s?s.short:``}`,c)}autoSecondary(e=this.state.bank,t=this.state.selectedKey){let n=this.state.banks[e]?.[t];if(!n)return``;let r=[];return B.forEach(e=>{n[e.id].length&&r.push(`${n[e.id].length} on ${e.label}`)}),r.join(` · `)}ident(e=this.state.bank,t=this.state.selectedKey){let n=`${e}:${t}`,r=this.state.naming[n]||{},i=this.autoName(e,t),a=this.autoSecondary(e,t),o=r.color||null,s=o?U[o]:`#16323d`;return{name:r.name!=null&&r.name!==``?r.name:i,secondary:r.secondary||``,color:o,textColor:r.textColor||(Je(s)?`cream`:`ink`),autoText:!r.textColor,raw:r,auto:i,autoSec:a}}setIdent(e,t=this.state.bank,n=this.state.selectedKey){let r=`${t}:${n}`,i={...this.state.naming,[r]:{...this.state.naming[r],...e}};this.set({naming:i})}colorFor(e,t){if(!t)return null;let n=W[e];if(!n)return null;if(n.colors===null)return t;if(!n.colors.length)return null;if(n.colors.includes(t))return t;let r=Ge[t];return r&&n.colors.includes(r)?r:n.colors[0]}switchController(e){let t=V.getController(e);this.set({controllerId:e,banks:G.createBanks(e),bank:0,selectedKey:t.keys[0],controllerPickerOpen:!1,popoverControlId:null,colorPickerOpen:!1})}openConnect(){this.set({connectOpen:!0})}closeConnect(){this.set({connectOpen:!1})}pushLog(e){let t=this.state.seq+1,n={n:t,...e},r=[...this.state.log,n].slice(-60);this.set({seq:t,log:r})}toggleConn(e){let t=!!this.state.conn[e],n={...this.state.conn,[e]:!t},r=t&&this.state.listening===e?null:this.state.listening;this.set({conn:n,listening:r});let i=q.getHardwareNodes(this.state).find(t=>t.id===e);this.pushLog({text:(t?`closed `:`opened `)+(i?i.port:e),sub:i?i.name:e,tone:t?`warn`:`ok`})}stompTest(){let e=this.state,t=e.banks[e.bank]?.[e.selectedKey]?.[e.action]||[],n=B.find(t=>t.id===e.action),r=n?n.label:e.action;if(!t.length){this.pushLog({text:`switch ${e.selectedKey} · ${r}`,sub:`nothing stacked here`,tone:`warn`});return}this.pushLog({text:`▸ switch ${e.selectedKey} · ${r}`,sub:`${t.length} ${t.length===1?`message`:`messages`} out`,tone:`trig`}),t.forEach((t,n)=>{setTimeout(()=>{let n=R[t.device];if(!n)return;let r=n.controls.find(e=>e.id===t.control),i=e.channels[t.device]||1,a=(r?r.cc:10)+(e.offsets[t.device]||0),o=t.value===null?127:t.value,s=!!e.conn[t.device];s&&q.sendControlChange(i,a,o),this.pushLog({text:`${K(176+i-1)} ${K(a)} ${K(o)}`,sub:s?`${n.name} · ${r?r.label:t.control}`:`${n.name} never answered — is it plugged in?`,tone:s?`out`:`warn`})},110*n)})}simScribblePresets(){let e=this.state,t=e.rig;if(!t.length)return[];let n=[1,2,3,5,8,13,17,21,34,55,64,89,127],r=H.map(e=>e[0]);return n.map((n,i)=>{let a=t[i%t.length],o=R[a],s=o?o.controls.filter(e=>e.type===`foot`):[],c=s[i%Math.max(s.length,1)]||(o?o.controls[0]:null),l=c?[{device:a,control:c.id,value:null}]:[];if(i%3!=2&&t.length>1){let e=t[(i+1)%t.length],n=R[e],r=n?n.controls.filter(e=>e.type===`knob`):[],a=r[i%Math.max(r.length,1)]||(n?n.controls[0]:null);a&&l.push({device:e,control:a.id,value:16*(i%7+1)})}if(i%4==1&&t.length>2){let e=t[(i+2)%t.length],n=R[e];if(n&&n.controls.length){let t=n.controls[(i+1)%n.controls.length];l.push({device:e,control:t.id,value:127})}}return{n,label:`${o?o.name.split(` `)[0].toUpperCase():`PEDAL`} ${c?(c.short||c.label||``).split(` `)[0]:``}`.slice(0,12).trim(),second:`${o?o.name.toLowerCase():a} · ch ${e.channels[a]||1}`,color:r[i%r.length],steps:l}})}async readFrom(e,t){let n=this.state,r=z[n.controllerId],i=r?r.keys:[`A`,`B`,`C`,`D`],a=!t;if(this.set({readOpen:!0,readData:{from:e,presets:[],dest:{},filter:``,allPresets:[],readingHardware:a,scanned:0,total:128,found:0},connectOpen:!1}),a){this.pushLog({text:`querying ${e}...`,sub:`sending Web Serial / MIDI query to device`,tone:`trig`});for(let e=1;e<=16;e++)setTimeout(()=>{if(!this.state.readData||!this.state.readData.readingHardware)return;let t=Math.round(8*e);this.set({readData:{...this.state.readData,scanned:t,found:Math.min(t,13)}})},95*e)}let o=t;o||=await q.readLiveDeviceConfig(e)??void 0;let s=o?pt(o,n.channels,i):[],c=H.map(e=>e[0]),l=s.length?s.map((e,t)=>{let r=e.slotNumber??e.bankIndex*i.length+(i.indexOf(e.key)>=0?i.indexOf(e.key)+1:t+1);return{n:r,label:e.presetName,second:e.secondaryText||`${R[e.steps[0]?.device]?.name||`pedal`} · ch ${n.channels[e.steps[0]?.device]||1}`,color:e.color||c[(r-1)%c.length],steps:e.steps}}):this.simScribblePresets(),u=s.map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0})),d=q.getHardwareNodes(n).find(t=>t.id===e);this.pushLog({text:`read ${d?d.name:e}`,sub:o?`${l.length} device presets loaded live from physical Scribble`:`live hardware query finished — select scribble.json file if USB CDC requires manual grant`,tone:o?`ok`:`warn`}),this.set({readData:{from:e,presets:l,dest:{},filter:``,allPresets:u,readingHardware:!1,scanned:128,total:128,found:l.length}})}async readLiveUsbSerial(){this.set({readOpen:!0,readData:{from:`scribble`,presets:[],dest:{},filter:``,allPresets:[],readingHardware:!0,scanned:0,total:128,found:0}});for(let e=1;e<=16;e++)setTimeout(()=>{if(!this.state.readData||!this.state.readData.readingHardware)return;let t=Math.round(8*e);this.set({readData:{...this.state.readData,scanned:t,found:Math.min(t,13)}})},95*e);let e=await q.requestLiveSerialConfig(),t=this.state,n=z[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`],i=e?pt(e,t.channels,r):[],a=H.map(e=>e[0]),o=i.length?i.map((e,n)=>{let i=e.slotNumber??e.bankIndex*r.length+(r.indexOf(e.key)>=0?r.indexOf(e.key)+1:n+1);return{n:i,label:e.presetName,second:e.secondaryText||`${R[e.steps[0]?.device]?.name||`pedal`} · ch ${t.channels[e.steps[0]?.device]||1}`,color:e.color||a[(i-1)%a.length],steps:e.steps}}):this.simScribblePresets(),s=i.map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0}));this.pushLog({text:`read USB device`,sub:e?`${o.length} presets loaded live from physical Scribble`:`no USB serial data received — select scribble.json file`,tone:e?`ok`:`warn`}),this.set({readData:{from:`scribble`,presets:o,dest:{},filter:``,allPresets:s,readingHardware:!1,scanned:128,total:128,found:o.length}})}async connectAndImportScribble(){this.pushLog({text:`connecting to Scribble...`,sub:`requesting USB device permission`,tone:`trig`});let e=await q.requestLiveSerialConfig(),t=this.state,n=z[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`];if(e){let n=pt(e,t.channels,r).map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0}));if(n.length>0){this.loadPresetsIntoBanks(n),this.pushLog({text:`Scribble connected & synced`,sub:`imported ${n.length} active hardware presets`,tone:`ok`}),this.set({connectOpen:!1});return}}this.readFrom(`scribble`,e||void 0)}loadScribbleFile(e){this.readFrom(`scribble`,e)}setReadFilter(e){this.state.readData&&this.set({readData:{...this.state.readData,filter:e}})}setReadDest(e,t){if(!this.state.readData)return;let n={...this.state.readData.dest};if(!t)delete n[e];else{let r=t.split(`:`);n[e]={key:r[0],action:r[1],mode:n[e]?.mode||`replace`}}this.set({readData:{...this.state.readData,dest:n}})}setReadDestMode(e,t){if(!this.state.readData||!this.state.readData.dest[e])return;let n={...this.state.readData.dest,[e]:{...this.state.readData.dest[e],mode:t}};this.set({readData:{...this.state.readData,dest:n}})}applyPresets(){let e=this.state.readData;if(!e||!e.presets)return;let t=e.presets.filter(t=>e.dest[t.n]).map(t=>({p:t,d:e.dest[t.n]})),n=this.state,r=n.bank,i=n.banks.map(e=>{let t={};return Object.keys(e).forEach(n=>{t[n]={press:[...e[n].press],hold:[...e[n].hold],double:[...e[n].double]}}),t}),a={...n.naming};t.forEach(({p:e,d:t})=>{let n=i[r]?.[t.key];if(n&&(t.mode===`add`?n[t.action]=[...n[t.action],...e.steps.map(e=>({...e}))].slice(0,Y):n[t.action]=e.steps.map(e=>({...e})),t.mode===`replace`)){let n=`${r}:${t.key}`;a[n]={name:e.label,secondary:e.second,color:e.color}}}),this.pushLog({text:t.length?`pulled ${t.length} ${t.length===1?`preset`:`presets`} in`:`took nothing`,sub:t.length?t.map(e=>`p${String(e.p.n).padStart(3,`0`)} → ${e.d.key}`).join(`, `):`left the rig as it was`,tone:`ok`}),this.set({banks:i,naming:a,readOpen:!1,readData:null})}togglePresetSelection(e){if(!this.state.readData||!this.state.readData.allPresets)return;let t=this.state.readData.allPresets.map(t=>t.id===e?{...t,selected:!t.selected}:t);this.set({readData:{...this.state.readData,allPresets:t}})}selectAllReadPresets(e){if(!this.state.readData||!this.state.readData.allPresets)return;let t=this.state.readData.allPresets.map(t=>({...t,selected:e}));this.set({readData:{...this.state.readData,allPresets:t}})}importSinglePreset(e){let t=this.state,n=t.bank,r=t.selectedKey,i=t.banks.map((t,i)=>{if(i!==n)return t;let a={...t};return a[r]={...a[r],press:[...e.steps]},a}),a=`${n}:${r}`,o={...t.naming,[a]:{name:e.presetName,secondary:e.secondaryText}};this.pushLog({text:`imported preset "${e.presetName}"`,sub:`loaded into Bank ${n+1} - Switch ${r}`,tone:`ok`}),this.set({banks:i,naming:o})}loadPresetsIntoBanks(e){if(!e||!e.length)return;let t=this.state,n=z[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`],i=Math.max(...e.map(e=>e.bankIndex),0),a=Math.max(t.banks.length,i+1),o=[];for(let e=0;e<a;e++){let n={...t.banks[e]||G.createBanks(t.controllerId)[0]};Object.keys(n).forEach(e=>{n[e]={press:[...n[e].press],hold:[...n[e].hold],double:[...n[e].double]}}),o.push(n)}let s={...t.naming};e.forEach(e=>{if(e.bankIndex<o.length&&r.includes(e.key)){o[e.bankIndex][e.key]&&(o[e.bankIndex][e.key].press=[...e.steps]);let t=`${e.bankIndex}:${e.key}`;s[t]={name:e.presetName,secondary:e.secondaryText}}});let c={...t.conn,scribble:!0};this.set({banks:o,naming:s,conn:c,readOpen:!1,readData:null})}importSelectedDevicePresets(){let e=this.state.readData;if(!e||!e.allPresets||!e.allPresets.length)return;let t=e.allPresets.filter(e=>e.selected);t.length&&(this.loadPresetsIntoBanks(t),this.pushLog({text:`imported ${t.length} presets from Scribble`,sub:`loaded into Stomp Stacks banks & macro stacks`,tone:`ok`}))}pickReadRow(e,t){}applyRead(){this.importSelectedDevicePresets()}cancelRead(){this.set({readOpen:!1,readData:null})}listenTo(e){if(!this.state.conn[e])return;this.set({listening:e,heard:null});let t=R[e];if(!t)return;let n={blooper:4,mood:0,elcap:-2}[e]||0,r=t.controls[2]||t.controls[0],i=r?r.cc:10,a=this.state.offsets[e]||0;setTimeout(()=>{if(this.state.listening!==e)return;let o=i+a+n,s=i+a;this.set({heard:{pedal:e,control:r.id,cc:o,expect:s,drift:n}});let c=this.state.channels[e]||1;this.pushLog({text:`${K(176+c-1)} ${K(o)} 7F`,sub:`${t.name} sent this when you moved ${r.short||r.label}`,tone:`in`})},1100)}acceptDrift(){let e=this.state.heard;if(!e)return;let t=R[e.pedal],n={...this.state.offsets,[e.pedal]:(this.state.offsets[e.pedal]||0)+e.drift};this.set({offsets:n,heard:null,listening:null}),this.pushLog({text:`shifted ${t?t.name:e.pedal} by ${e.drift>0?`+`:``}${e.drift}`,sub:`its whole map moves with it`,tone:`ok`})}dismissHeard(){this.set({heard:null,listening:null})}toggleMonitor(){this.set({monitorOn:!this.state.monitorOn})}clearLog(){this.set({log:[]})}},X=class{constructor(e,t){this.onChange=()=>this.host.requestUpdate(),this.host=e,this.store=t,e.addController(this)}hostConnected(){this.store.addEventListener(`change`,this.onChange)}hostDisconnected(){this.store.removeEventListener(`change`,this.onChange)}};function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var vt=class extends j{constructor(...e){super(...e),this.desktop=!1}static{this.styles=[P,F,o`
    ...
    `}};Z([N({attribute:!1})],vt.prototype,`store`,void 0),Z([N({type:Boolean,reflect:!0})],vt.prototype,`desktop`,void 0),vt=Z([M(`controller-graphic`)],vt);var yt=class extends j{static{this.styles=[P,F,I,o`
      :host {
        display: block;
        position: relative;
        overflow: visible;
    ...
    `}};Z([N({attribute:!1})],yt.prototype,`store`,void 0),yt=Z([M(`device-tabs`)],yt);var bt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},xt=e=>(...t)=>({_$litDirective$:e,values:t}),St=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},Ct=`important`,wt=` !important`,Tt=xt(class extends St{constructor(e){if(super(e),e.type!==bt.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(wt);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?Ct:``):n[e]=r}}return E}}),Q=class extends j{constructor(...e){super(...e),this.phone=!1,this.desktop=!1}static{this.styles=[P,F,o`
      :host {
        display: flex;
        flex: 1;
        min-width: 0;
...
`)}}compilePreview(e){let t=[],n=(e,n)=>{t.push({text:e===``?` `:e,...n})};return lt(e,(t,r,i,a,o)=>{n(`▸ bank ${t+1} · ${r} ${a.label}`,{bold:!0}),o.forEach(t=>{let r=J(t,e.channels);n(`    ${jt(176+r.channel-1)} ${jt(r.cc)} ${jt(r.value)}    ${r.deviceName} ${r.label}`,{muted:!0})}),n(``)}),t.length||n(`nothing stacked yet — go poke a pedal`,{muted:!0}),t}},Nt={rig:new kt,mc3:new ct,scribble:new mt,labels:new At,trace:new Mt};function Pt(e){let t=V.getBrain(e.brainId),n=V.getController(e.controllerId),r=[],i=0,a=0;lt(e,(e,n,r,o,s)=>{s.length>t.maxSteps&&(i++,s.length>a&&(a=s.length))}),i&&r.push({type:`warn`,text:`${i} stack${i===1?``:`s`} run to ${a} messages — ${t.full.toLowerCase()} sends ${t.maxSteps}${e.brainId===`none`?`. this is the case for a brain.`:`. trim them or move up.`}`}),e.banks.length>t.banks&&r.push({type:`warn`,text:`${n.name} has ${e.banks.length} banks; ${t.full.toLowerCase()} holds ${t.banks}.`}),e.brainId===`onboard`&&!n.onboard&&r.push({type:`warn`,text:`${n.name} can't hold stacks onboard — it only sends one message per switch.`});let o=Et(e).filter(t=>!e.rig.includes(t));o.length&&r.push({type:`warn`,text:`${o.map(e=>V.getDevice(e)?.name||e).join(` + `)} ${o.length===1?`is`:`are`} stacked but no longer in the rig — those steps won't be sent.`}),V.detectChannelCollisions(e.rig,e.channels).forEach(({channel:e,devices:t})=>{r.push({type:`warn`,text:`${t.join(` + `)} are both on channel ${e} — their cc numbers will collide.`})}),e.targetId===`mc3`&&e.controllerId!==`mc3`&&r.push({type:`warn`,text:`building an mc3 preset, but the rig is set to ${n.name}.`}),e.targetId===`scribble`&&e.brainId!==`scribble`&&r.push({type:`warn`,text:`building a scribble config, but the brain is set to ${t.full.toLowerCase()}.`});let s={state:e,namingTargets(){let t=[e.controllerId];return e.brainId===`scribble`&&t.push(`scribble`),t.filter(e=>W[e]).map(e=>({...W[e]}))},displayTargets(){return this.namingTargets().filter(e=>e.name>0)},sharedColors(){let e=this.namingTargets().filter(e=>e.colors===null||e.colors.length>0);return e.length?H.map(e=>e[0]).filter(t=>e.every(e=>e.colors===null||e.colors&&e.colors.includes(t))):[]}},c=[];e.banks.forEach((t,n)=>{Object.keys(t).forEach(r=>{let i=0;if(B.forEach(e=>{i+=t[r][e.id].length}),i){let t=`${n}:${r}`,i=e.naming&&e.naming[t]||{};c.push({name:i.name||``,secondary:i.secondary||``,color:i.color||null,raw:i})}})}),s.displayTargets().forEach(e=>{let t=c.filter(t=>t.raw.name&&t.name.length>e.name).length;if(t&&r.push({type:`warn`,text:`${t} ${t===1?`name is`:`names are`} longer than the ${e.label.toLowerCase()} shows (${e.name} characters) — ${t===1?`it reads`:`they read`} trimmed there.`}),!e.secondary){let t=c.filter(e=>e.secondary).length;t&&r.push({type:`warn`,text:`${t} second ${t===1?`line has`:`lines have`} nowhere to go on the ${e.label.toLowerCase()} — ${t===1?`it lands`:`they land`} on the label sheet instead.`})}});let l=s.sharedColors(),u={};return c.forEach(e=>{e.color&&(!l.length||!l.includes(e.color))&&(u[e.color]=!0)}),Object.keys(u).forEach(e=>{let t=e,n=s.namingTargets().filter(e=>e.colors&&e.colors.length&&!e.colors.includes(t));n.length&&r.push({type:`warn`,text:`${e} isn't in ${n.map(e=>e.label.toLowerCase()).join(` or `)}'s palette — those stacks fall back to a compatible color there.`})}),r.length||r.push({type:`ok`,text:`all clear — nothing collides, nothing overflows.`}),r}var Ft=class{static compile(e,t=e.targetId){let n=Nt[t]||Nt.rig;return{targetId:t,exportFile:n.compileExport(e),preview:n.compilePreview(e),diagnostics:Pt(e)}}static getAdapter(e){return Nt[e]||Nt.rig}};Ft.compile;var $=class extends j{constructor(...e){super(...e),this.phone=!1,this.desktop=!1}static{this.styles=[P,F,I,o`
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=e.banks[e.bank],n=this.store.activeStack,r=e.sheetOpen||!this.phone;this.phone?this.style.maxHeight=r?`56%`:`none`:this.style.maxHeight=``;let i=V.getDevice(e.browseDevice),a=e.popoverControlId?V.getControl(e.browseDevice,e.popoverControlId):null,o=this.store.ident(e.bank,e.selectedKey),s=this.store.sharedColors(),c=H.map(e=>e[0]).filter(e=>s.length>0&&!s.includes(e)),l=this.store.displayTargets().length>0||s.length>0,u=o.color?U[o.color]:`#16323d`,d=We[o.textColor],f=[];if(l&&(this.store.displayTargets().forEach(e=>{o.raw.name&&o.name.length>e.name&&f.push(`${e.label.toLowerCase()} shows “${o.name.slice(0,e.name)}”`),o.secondary&&!e.secondary?f.push(`${e.label.toLowerCase()} drops the second line`):o.secondary&&o.secondary.length>e.secondary&&f.push(`${e.label.toLowerCase()} trims line two to “${o.secondary.slice(0,e.secondary)}”`)}),o.color&&s.length>0&&!s.includes(o.color))){let e=this.store.namingTargets().filter(e=>e.colors&&e.colors.length>0&&!e.colors.includes(o.color));e.length&&f.push(`${o.color} is out of range on ${e.map(e=>e.label.toLowerCase()).join(` + `)}`)}return T`
      ...
      ${r?T`
          ...
          `:null}
    `}};Z([N({attribute:!1})],$.prototype,`store`,void 0),Z([N({type:Boolean,reflect:!0})],$.prototype,`phone`,void 0),Z([N({type:Boolean,reflect:!0})],$.prototype,`desktop`,void 0),$=Z([M(`macro-panel`)],$);function It(e,t){let n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function Lt(e,t){let n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}var Rt=class extends j{constructor(...e){super(...e),this.phone=!1}static{this.styles=[P,F,L,I,o`
      .panel {
        width: 880px;
        max-width: 100%;
        max-height: 88vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}handleDownload(){let e=this.store.state,t=Ft.compile(e);t.exportFile.mimeType===`application/json`?It(t.exportFile.filename,JSON.parse(t.exportFile.content)):Lt(t.exportFile.filename,t.exportFile.content)}render(){let e=this.store.state;if(!e.compileOpen)return null;let t=this.store.totalAssigned,n=V.getController(e.controllerId),r=V.getBrain(e.brainId),i=e.rig.length?e.rig.map(e=>V.getDevice(e)?.name||e).join(`, `):`no pedals yet`,a=`${t} ${t===1?`message`:`messages`} · ${n.short} → ${r.short} → ${i}`,o=V.getTarget(e.targetId),s=Ft.compile(e),c=s.preview,l=s.diagnostics;return T`
    ...
    `}};Z([N({attribute:!1})],Rt.prototype,`store`,void 0),Z([N({type:Boolean,reflect:!0})],Rt.prototype,`phone`,void 0),Rt=Z([M(`compile-modal`)],Rt);var zt=[{id:`photo`,label:`photo`},{id:`drawn`,label:`sketch`}],Bt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 520px;
        max-width: 100%;
        max-height: 90vh;
            ...
            ${i?T`
                  <div class="section" style="padding-top:4px;padding-bottom:22px">
                    ...
                    <div class="conventions-container">
                      ${a.map((e,n)=>{let r=this.store.colorFor(e.id,t.color),i=e.name===0?`#f7f1e3`:r?U[r]:`#16323d`,a=e.name===0?`#16323d`:e.text?We[t.textColor]:Je(i)?`#f7f1e3`:`#16323d`,o=[];e.name?o.push(`${e.name} char${e.secondary?` × 2 lines`:``}`):o.push(`no display`),e.colors===null?o.push(`any colour`):e.colors.length&&o.push(`${e.colors.length} leds`);let s=e.name?t.name.slice(0,e.name):t.name,c=e.secondary>0&&!!t.secondary,l=t.secondary.slice(0,e.secondary);return T`
                          <div
    ...
    `}};Z([N({attribute:!1})],Bt.prototype,`store`,void 0),Bt=Z([M(`settings-modal`)],Bt);var Vt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 470px;
        max-width: 100%;
        background: var(--card);
    ...
    `:null}};Z([N({attribute:!1})],Vt.prototype,`store`,void 0),Vt=Z([M(`controller-picker-modal`)],Vt);var Ht=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 500px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `:null}};Z([N({attribute:!1})],Ht.prototype,`store`,void 0),Ht=Z([M(`brain-picker-modal`)],Ht);var Ut=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 480px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `}};Z([N({attribute:!1})],Ut.prototype,`store`,void 0),Ut=Z([M(`add-pedal-modal`)],Ut);var Wt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 420px;
        max-width: 100%;
        background: var(--card);
    ...
    `}};Z([N({attribute:!1})],Wt.prototype,`store`,void 0),Wt=Z([M(`confirm-remove-modal`)],Wt);var Gt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 540px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `}};Z([N({attribute:!1})],Gt.prototype,`store`,void 0),Gt=Z([M(`connect-modal`)],Gt);function Kt(e){return!e||!e.length?`empty`:e.map(e=>{let t=R[e.device],n=t?.controls.find(t=>t.id===e.control);return`${t?t.name:e.device} ${n?n.short||n.label:e.control}`}).join(` → `)}var qt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 660px;
        max-width: 100%;
        max-height: 90vh;
            ...
            ${f.length===0?T`
                ...
                `:T`
                  <div class="preset-list">
                    ${f.map(n=>{let r=t.dest[n.n]||null,i=`p${String(n.n).padStart(3,`0`)}`,a=n.color&&U[n.color]?U[n.color]:`var(--ink)`,o=n.color&&U[n.color]&&!Je(U[n.color])?`var(--ink)`:`#fdf3d4`,s=r?`${r.key}:${r.action}`:``,c=r&&e.banks[e.bank]?.[r.key]?.[r.action]?e.banks[e.bank][r.key][r.action]:null,l=r?B.find(e=>e.id===r.action):null,u=l?l.label.toLowerCase():r?.action||``,d=r?c&&c.length?`switch ${r.key} · ${u} already holds ${c.length} ${c.length===1?`message`:`messages`}`:`switch ${r.key} · ${u} is empty`:``;return T`
                        <div class="preset-slot-row" ?assigned=${!!r}>
                          <div class="preset-top">
                            ...
                            <div class="preset-info">
                              ...
                              <span class="preset-steps">${n.second||Kt(n.steps)}</span>
                            </div>
                            <select
                              class="dest-select"
                              ?assigned=${!!r}
    ...
    `}};Z([N({attribute:!1})],qt.prototype,`store`,void 0),qt=Z([M(`read-modal`)],qt);var Jt=class extends j{static{this.styles=[P,F,I,o`
      :host {
        display: block;
        flex: none;
        border-top: 2.5px solid var(--ink);
    ...
    `:null}};Z([N({attribute:!1})],Jt.prototype,`store`,void 0),Jt=Z([M(`wire-monitor`)],Jt);var Yt=760,Xt=1120,Zt=class extends j{static{this.styles=[P,F,o`
      :host {
        display: block;
        height: 100vh;
      }
    ...
    `}};Z([N({type:Boolean,reflect:!0})],Zt.prototype,`phone`,void 0),Z([N({type:Boolean,reflect:!0})],Zt.prototype,`desktop`,void 0),Zt=Z([M(`stomp-app`)],Zt);