...
`,Ie=[{label:`min`,value:0},{label:`9 o'clock`,value:32},{label:`noon`,value:64},{label:`3 o'clock`,value:96},{label:`max`,value:127}],Le=[{label:`left`,value:0},{label:`centre`,value:64},{label:`right`,value:127}],R={blooper:{id:`blooper`,name:`blooper`,faceName:`blooper`,sub:`bottomless looper`,accent:`#8fd0e6`,body:`#bfe2ec`,ink:`#173b47`,midiChannel:3,pcOffset:0,photo:`assets/blooper-face.png`,pw:508,ph:948,notes:[`Zero-Based Program Changes: Blooper is a zero-based MIDI pedal. Loops 1-16 are saved and recalled using Program Changes 0-15. This allows for the use of Faves for recalling loops and puts presets in line with BOSS ES and MS series controllers. Other controllers have an option for "PC Offset" set to 0.`,`TRS MIDI Connection: Blooper uses a 1/4" TRS Ring Active connection. Requires a Chase Bliss MIDIBox or compatible TRS adapter for 5-pin MIDI controllers.`,`Default Channel: Listens on MIDI Channel 2 by default (configurable by holding both stomp switches at power-on and sending a Program Change).`,`Additive Mode Overdubs: In Additive mode, MIDI CC movements for Modifiers or Stability can be recorded directly into loop overdubs.`],controls:[{id:`volume`,short:`ramp volume`,label:`Ramp / Volume`,type:`knob`,cc:14,x:22,y:12,px:18.7,py:9.7,ps:20.7},{id:`layers`,short:`layers`,label:`Layers`,type:`knob`,cc:17,notes:`Navigates loop layer undo/redo history (0-127)`,x:50,y:12,px:49.2,py:9.5,ps:19.7},{id:`repeats`,short:`repeats`,label:`Repeats`,type:`knob`,cc:15,x:78,y:12,px:82,py:9.5,ps:19.7},{id:`modA`,short:`mod a`,label:`Modifier A`,type:`knob`,cc:30,x:22,y:33,px:19.1,py:29.7,ps:20.7},{id:`stability`,short:`stability`,label:`Stability`,type:`knob`,cc:18,x:50,y:33,px:49.6,py:29.5,ps:19.7},{id:`modB`,short:`mod b`,label:`Modifier B`,type:`knob`,cc:31,x:78,y:33,px:82,py:29.7,ps:19.7},{id:`chA`,short:`1 2 3`,label:`Mod A channel`,type:`toggle`,cc:21,x:22,y:52,px:19.7,py:46.8,ps:12.2,values:[{label:`1`,value:0},{label:`2`,value:64},{label:`3`,value:127}]},{id:`mode`,short:`norm add samp`,label:`Norm / Add / Samp`,type:`toggle`,cc:22,x:50,y:52,px:49.8,py:46.8,ps:12.2,values:[{label:`normal`,value:0},{label:`additive`,value:64},{label:`sampling`,value:127}]},{id:`chB`,short:`4 5 6`,label:`Mod B channel`,type:`toggle`,cc:23,x:78,y:52,px:80.7,py:46.8,ps:12.2,values:[{label:`4`,value:0},{label:`5`,value:64},{label:`6`,value:127}]},{id:`undo`,short:`undo / redo`,label:`Undo / Redo`,type:`toggle`,cc:5,notes:`CC 5 triggers Undo, CC 6 triggers Redo`,x:50,y:82,px:49.8,py:85.7,ps:9.1,values:[{label:`undo`,value:0},{label:`off`,value:64},{label:`redo`,value:127}]},{id:`record`,short:`record`,label:`Record`,type:`foot`,cc:1,notes:`CC 1 triggers Record`,x:28,y:82,px:19.1,py:89.1,ps:19.7},{id:`loop`,short:`loop`,label:`Loop`,type:`foot`,cc:2,notes:`CC 2 triggers Play/Loop, CC 4 triggers Stop`,x:72,y:82,px:79.8,py:89.1,ps:19.7}]},mood:{id:`mood`,name:`MOOD`,faceName:`MOOD`,sub:`instant ambience`,accent:`#ef7d5c`,body:`#e8785a`,ink:`#4a150c`,midiChannel:2,photo:`assets/mood-face.png`,pw:507,ph:957,notes:[`Independent Channel Bypass: CC 102 controls Micro-looper bypass (0=Off, 127=On) and CC 103 controls Wet channel bypass (0=Off, 127=On). On classic MOOD, CC 103 values 0 (both off), 45 (micro only), 85 (wet only), 127 (both on) set combined states.`,`TRS MIDI Connection: Uses 1/4" TRS Ring Active MIDI jack (requires Chase Bliss MIDIBox or TRS MIDI cable).`,`Default Channel: Set to MIDI Channel 2 by default.`,`Clock Sync & Subdivisions: CC 18 controls master clock speed. In Tape mode, Length (CC 16) quantizes loop subdivisions (x/32, x/16, x/8, x/4, x/2, x/1).`],controls:[{id:`time`,short:`time`,label:`Time`,type:`knob`,cc:14,x:22,y:12,px:17.9,py:10.1,ps:20.7},{id:`mix`,short:`mix (ramp)`,label:`Mix (Ramp)`,type:`knob`,cc:15,x:50,y:12,px:48.9,py:10.1,ps:19.8},{id:`length`,short:`length`,label:`Length`,type:`knob`,cc:16,x:78,y:12,px:81.5,py:10.1,ps:19.8},{id:`modWet`,short:`modify`,label:`Modify — wet`,type:`knob`,cc:17,x:22,y:33,px:17.9,py:30.5,ps:20.7},{id:`clock`,short:`clock`,label:`Clock`,type:`knob`,cc:18,x:50,y:33,px:49.3,py:30.3,ps:19.8},{id:`modMicro`,short:`modify`,label:`Modify — micro`,type:`knob`,cc:19,x:78,y:33,px:81.8,py:30.5,ps:19.8},{id:`wetmode`,short:`reverb delay slip`,label:`Wet effect`,type:`toggle`,cc:21,x:22,y:52,px:19.3,py:47,ps:12.2,values:[{label:`reverb`,value:0},{label:`delay`,value:64},{label:`slip`,value:127}]},{id:`routing`,short:`in · ○+in · ○`,label:`Routing`,type:`toggle`,cc:22,x:50,y:52,px:49.5,py:47,ps:12.2,values:[{label:`in`,value:0},{label:`loop + in`,value:64},{label:`loop`,value:127}]},{id:`micromode`,short:`stretch tape env`,label:`Micro-looper mode`,type:`toggle`,cc:23,x:78,y:52,px:80.5,py:47,ps:12.2,values:[{label:`stretch`,value:0},{label:`tape`,value:64},{label:`env`,value:127}]},{id:`bypass`,short:`bypass`,label:`Bypass mode`,type:`toggle`,cc:103,notes:`CC 103 controls Wet channel bypass; CC 102 controls Micro-looper bypass`,x:50,y:82,px:49.5,py:86.7,ps:9.1,values:Le},{id:`wet`,short:`wet`,label:`Wet channel`,type:`foot`,cc:103,notes:`CC 103 toggles Wet channel bypass`,x:28,y:82,px:18.4,py:90.3,ps:19.8},{id:`microloop`,short:`micro`,label:`Micro-looper`,type:`foot`,cc:102,notes:`CC 102 toggles Micro-looper bypass`,x:72,y:82,px:79.5,py:90.3,ps:19.8}]},elcap:{id:`elcap`,name:`el capistan`,faceName:`el capistan`,sub:`dTape echo`,accent:`#7b62b8`,body:`#c7ced2`,ink:`#20262b`,midiChannel:1,photo:`assets/elcap-face.png`,pw:775,ph:872,notes:[`EXP/MIDI Jack Setup: Must configure EXP/MIDI jack to MIDI mode at power-up (hold TAP footswitch, turn MIX knob until ON LED turns BLUE).`,`Default Channel: Defaults to MIDI Channel 1.`,`Bypass CC: CC 102 with value 127 engages effect; value 0 bypasses.`,`Clock Division: CC 25 controls Clock Division on V2 firmware.`],controls:[{id:`time`,short:`time`,label:`Time`,type:`knob`,cc:12,x:22,y:13,px:14.9,py:18,ps:17},{id:`cmix`,short:`mix`,label:`Mix`,type:`knob`,cc:14,x:78,y:13,px:85.1,py:18,ps:17},{id:`age`,short:`tape age`,label:`Tape Age`,type:`knob`,cc:16,x:38,y:33,px:38,py:37.3,ps:17},{id:`repeats`,short:`repeats`,label:`Repeats`,type:`knob`,cc:15,x:62,y:33,px:62,py:37.3,ps:17},{id:`wow`,short:`wow & flutter`,label:`Wow & Flutter`,type:`knob`,cc:13,x:22,y:45,px:14.9,py:42.5,ps:17},{id:`spring`,short:`spring`,label:`Spring`,type:`knob`,cc:18,x:78,y:45,px:85.1,py:42.5,ps:17},{id:`head`,short:`tape head`,label:`Tape head`,type:`toggle`,cc:11,x:40,y:13,px:42.8,py:18,ps:6.7,values:[{label:`fixed`,value:0},{label:`multi`,value:64},{label:`single`,value:127}]},{id:`cmode`,short:`mode`,label:`Mode`,type:`toggle`,cc:19,x:60,y:13,px:56.9,py:18,ps:6.7,values:[{label:`a`,value:0},{label:`b`,value:64},{label:`c`,value:127}]},{id:`tap`,short:`tap`,label:`Tap`,type:`foot`,cc:93,notes:`CC 93 triggers Tap tempo pulse`,x:28,y:82,px:18.8,py:80.1,ps:14.2},{id:`onoff`,short:`on`,label:`On / bypass`,type:`foot`,cc:102,notes:`CC 102 value 127 engages, 0 bypasses`,x:72,y:82,px:81.8,py:80.1,ps:14.2}]},genloss:{id:`genloss`,name:`generation loss`,faceName:`generation loss`,sub:`video decay`,accent:`#6d93ad`,body:`#a9c3d4`,ink:`#1f3b4d`,midiChannel:4,photo:`assets/genloss-face.png`,pw:497,ph:944,notes:[`TRS MIDI Connection: Uses Chase Bliss 1/4" TRS Ring Active MIDI connection.`,`Default Channel: Configurable MIDI Channel (defaults to Channel 4 in multi-pedal rigs).`],controls:[{id:`wow`,short:`wow`,label:`Wow`,type:`knob`,cc:14,x:22,y:12,px:18.3,py:8.7,ps:22.1},{id:`volume`,short:`volume ramp`,label:`Volume (Ramp)`,type:`knob`,cc:15,x:50,y:12,px:49.5,py:8.7,ps:21.1},{id:`model`,short:`model`,label:`Model / LP`,type:`knob`,cc:16,x:78,y:12,px:82.7,py:8.7,ps:21.1},{id:`flutter`,short:`flutter`,label:`Flutter`,type:`knob`,cc:17,x:22,y:33,px:18.3,py:29.7,ps:22.1},{id:`saturate`,short:`saturate`,label:`Saturate / Gen`,type:`knob`,cc:18,x:50,y:33,px:49.5,py:29.7,ps:21.1},{id:`failure`,short:`failure`,label:`Failure / HP`,type:`knob`,cc:19,x:78,y:33,px:82.7,py:29.7,ps:21.1},{id:`aux`,short:`stop filter fail`,label:`Aux`,type:`toggle`,cc:21,x:22,y:52,px:17.7,py:47,ps:13,values:[{label:`stop`,value:0},{label:`filter`,value:64},{label:`fail`,value:127}]},{id:`dry`,short:`none small unity`,label:`Dry`,type:`toggle`,cc:22,x:50,y:52,px:48.9,py:46.5,ps:13,values:[{label:`none`,value:0},{label:`small`,value:64},{label:`unity`,value:127}]},{id:`noise`,short:`none mild heavy`,label:`Noise`,type:`toggle`,cc:23,x:78,y:52,px:81.3,py:46.5,ps:13,values:[{label:`none`,value:0},{label:`mild`,value:64},{label:`heavy`,value:127}]},{id:`preset`,short:`preset`,label:`Preset toggle`,type:`toggle`,cc:101,x:50,y:82,px:49.5,py:85.8,ps:9.5,values:Le},{id:`auxSw`,short:`aux`,label:`Aux switch`,type:`foot`,cc:103,x:28,y:82,px:17.7,py:91.5,ps:21.1},{id:`bypass`,short:`bypass`,label:`Bypass`,type:`foot`,cc:102,x:72,y:82,px:79.7,py:91.5,ps:21.1}]}},Re=[`blooper`,`mood`,`elcap`,`genloss`],z={chocolate:{id:`chocolate`,name:`M-Vave Chocolate`,short:`chocolate`,sub:`4 switches · 4 banks`,keys:[`A`,`B`,`C`,`D`],x:[14,38,62,86],y:[42,42,42,42],height:74,heightDesktop:80,banks:4,screen:!1,onboard:!1,notes:[`Hardware Layout: 4 foot switches (A, B, C, D) across 4 banks.`,`No Onboard Macro Storage: Sends 1 MIDI message per switch. Requires an external smart relay hub (Pirate MIDI Scribble) to fan out multi-step macro stacks.`,`Editor & Connection: Configured via M-Vave CubeSuite app over Bluetooth or USB-C MIDI.`]},mc3:{id:`mc3`,name:`Morningstar MC3`,short:`mc3`,sub:`3 switches · 3 banks`,keys:[`A`,`B`,`C`],x:[26,74,50],y:[74,74,14],height:158,heightDesktop:170,banks:3,screen:!0,onboard:!0,notes:[`Hardware Layout: 3 foot switches (A, B, C) supporting 30 physical banks.`,`Onboard Macro Storage: Stores up to 16 MIDI messages per switch action directly in memory without requiring an external relay box.`,`Editor Integration: Exports native preset JSON for import via the Morningstar Editor.`,`Connectivity: Features OLED display screen, 1x 5-pin DIN MIDI Out, 4x 3.5mm TRS MIDI outputs, and USB-C MIDI.`]}},ze=[`chocolate`,`mc3`],B=[{id:`press`,label:`tap`},{id:`hold`,label:`hold`},{id:`double`,label:`double`}],Be={scribble:{id:`scribble`,short:`scribble`,full:`Scribble relay`,sub:`the little box in the loop — takes one message in, fans the whole stack out`,icon:`▤`,colour:`#8fd0e6`,maxSteps:8,banks:16,notes:[`Pirate MIDI Scribble Relay Hub: USB-C Host / TRS / BLE relay box.`,`Macro Capacity: Stores up to 8 MIDI messages per switch action across 16 banks (128 presets total).`,`Firmware Flashing: Configured via USB-C or web editor using scribble.json config file.`]},onboard:{id:`onboard`,short:`onboard`,full:`Controller onboard`,sub:`no extra box — the controller holds the stack itself`,icon:`◉`,colour:`#f7c948`,maxSteps:6,banks:3,notes:[`Controller Onboard Storage: Direct execution on smart controllers (like Morningstar MC3).`,`Macro Capacity: Stores up to 16 MIDI messages per action directly on the controller without requiring an external relay hub.`]},none:{id:`none`,short:`direct`,full:`No brain`,sub:`controller talks straight to the pedals — one message per stomp`,icon:`—`,colour:`#ef7d5c`,maxSteps:1,banks:16,notes:[`Direct Controller Setup: Controller sends 1 raw MIDI message per stomp directly to pedals.`,`No Macro Stacks: Triggers are limited to 1 step per action (no multi-pedal fanout).`]}},Ve=[`scribble`,`onboard`,`none`],He=[{id:`scribble`,label:`scribble.json`,sub:`relay config`,note:`flashes onto the scribble over usb`},{id:`mc3`,label:`mc3-preset.json`,sub:`native preset`,note:`import via the morningstar editor`},{id:`rig`,label:`rig.json`,sub:`portable source`,note:`the source of truth — every build comes from this`},{id:`labels`,label:`label sheet`,sub:`printable`,note:`one line per stomp, for the pedalboard`},{id:`log`,label:`midi log`,sub:`debug trace`,note:`raw bytes, in the order they leave`}],V=class e{static{this.controlMap=new Map}static{this.targetMap=new Map}static{Object.values(R).forEach(t=>{t.controls.forEach(n=>{e.controlMap.set(`${t.id}:${n.id}`,n)})}),He.forEach(t=>{e.targetMap.set(t.id,t)})}static getDevice(e){return R[e]}static getController(e){return z[e]||z.chocolate}static getBrain(e){return Be[e]||Be.none}static getTarget(t){return e.targetMap.get(t)||He[0]}static getControl(t,n){return e.controlMap.get(`${t}:${n}`)}static valueOptionsFor(e){return e.values?e.values:e.type===`knob`?Ie:[]}static formatControlLabel(t,n,r){let i=e.getControl(t,n);if(!i)return n;let a=i.label;if(r!=null){let t=e.valueOptionsFor(i).find(e=>e.value===r);t&&(a+=` · `+t.label)}return a}static findNextFreeChannel(e,t){let n={};e.forEach(e=>{t[e]&&(n[t[e]]=!0)});for(let e=1;e<=16;e++)if(!n[e])return e;return 1}static detectChannelCollisions(e,t){let n={};e.forEach(e=>{let r=R[e],i=t[e]||(r?r.midiChannel:1);(n[i]=n[i]||[]).push(r?.name||e)});let r=[];return Object.keys(n).forEach(e=>{let t=Number(e);n[t].length>1&&r.push({channel:t,devices:n[t]})}),r}static getDeviceAccentColorInt(e){let t=R[e];if(!t||!t.accent)return 0;let n=t.accent.replace(`#`,``);return n.length===6?parseInt(n,16):0}},H=[[`red`,`#ef5c4c`],[`orange`,`#ef7d5c`],[`yellow`,`#f7c948`],[`green`,`#5bb85b`],[`mint`,`#9fe0c0`],[`cyan`,`#8fd0e6`],[`blue`,`#5b8fd6`],[`purple`,`#7b62b8`],[`pink`,`#e08fc0`],[`white`,`#f4ede0`]],U=H.reduce((e,[t,n])=>(e[t]=n,e),{}),Ue=[[`ink`,`#16323d`],[`cream`,`#f7f1e3`],[`white`,`#ffffff`]],We=Ue.reduce((e,[t,n])=>(e[t]=n,e),{}),Ge={mint:`green`,pink:`purple`};function Ke(e){let t=e.startsWith(`#`)?e.slice(1):e;if(t.length!==6)return!0;let n=parseInt(t,16),r=n>>16&255,i=n>>8&255,a=n&255;return(r*299+i*587+a*114)/1e3<150}var W={scribble:{id:`scribble`,label:`Scribble relay`,role:`brain`,name:12,secondary:12,colors:null,text:!0,note:`a lit strip per switch: both lines, the colour, the text colour.`},mc3:{id:`mc3`,label:`Morningstar MC3`,role:`controller`,name:8,secondary:0,colors:[`red`,`orange`,`yellow`,`green`,`cyan`,`blue`,`purple`,`white`],text:!1,note:`one line on the shared screen, colour on the led. the second line has nowhere to go.`},chocolate:{id:`chocolate`,label:`M-Vave Chocolate`,role:`controller`,name:0,secondary:0,colors:[],text:!1,note:`no screen, no leds. this one only ever reaches the printed label sheet.`}},G=class e{static createBanks(e){let t=z[e]||z.chocolate,n=[];for(let e=0;e<t.banks;e++){let e={};t.keys.forEach(t=>{e[t]={press:[],hold:[],double:[]}}),n.push(e)}return n}static cloneBanks(e){return e.map(e=>{let t={};for(let n of Object.keys(e))t[n]={press:e[n].press.slice(),hold:e[n].hold.slice(),double:e[n].double.slice()};return t})}static getActiveStack(e,t,n,r){return!e[t]||!e[t][n]||!e[t][n][r]?[]:e[t][n][r]}static addOrToggleStep(t,n,r,i,a,o,s,c=8){let l=e.cloneBanks(t),u=l[n][r][i],d=u.findIndex(e=>e.device===a&&e.control===o&&e.value===s);return d>=0?(u.splice(d,1),l):(u.length>=c||u.push({device:a,control:o,value:s}),l)}static removeStep(t,n,r,i,a){let o=e.cloneBanks(t),s=o[n][r][i];return a>=0&&a<s.length&&s.splice(a,1),o}static moveStep(t,n,r,i,a,o){let s=e.cloneBanks(t),c=s[n][r][i],l=a+o;if(l>=0&&l<c.length&&a>=0&&a<c.length){let e=c[a];c[a]=c[l],c[l]=e}return s}static countTotalAssignedSteps(e){let t=0;for(let n of e)for(let e of Object.keys(n))t+=n[e].press.length+n[e].hold.length+n[e].double.length;return t}static usedDeviceIds(e){let t={};return e.forEach(e=>{Object.keys(e).forEach(n=>{B.forEach(({id:r})=>{e[n][r].forEach(e=>{t[e.device]=!0})})})}),Object.keys(t)}static usedControlIds(e,t){let n={};return e.forEach(e=>{Object.keys(e).forEach(r=>{B.forEach(({id:i})=>{e[r][i].forEach(e=>{e.device===t&&(n[e.control]=!0)})})})}),Object.keys(n)}},qe=5e3,Je=class extends Error{constructor(e,t){super(e),this.name=`DeviceApiError`,this.packet=t}},Ye=class{constructor(){this.buf=``}push(e){this.buf+=e;let t=[],n=this.buf.indexOf(`~`);for(;n!==-1;)t.push(this.buf.slice(0,n)),this.buf=this.buf.slice(n+1),n=this.buf.indexOf(`~`);return t}get pending(){return this.buf}reset(){this.buf=``}};function Xe(e){return e+`~`}function Ze(e){return e.trim()===`ok`}function Qe(e,t){let n=e.trim();try{return JSON.parse(n)}catch{throw new Je(`${t}: expected JSON but device sent ${n.slice(0,80)||`(empty packet)`}`,n)}}var $e=class{constructor(e,t=qe){this.buffer=new Ye,this.queue=[],this.chain=Promise.resolve(),this.transport=e,this.timeoutMs=t}exchange(e){let t=this.chain.then(e,e);return this.chain=t.catch(()=>void 0),t}async send(e){return await this.transport.write(Xe(e)),this.nextPacket(e)}async nextPacket(e){let t=this.queue.shift();if(t!==void 0)return t;let n=Date.now()+this.timeoutMs;for(;Date.now()<n;){let t=await this.readWithTimeout(n-Date.now());if(t===null)throw new Je(`${e}: serial stream closed before the device replied`);let r=this.buffer.push(t);if(r.length>0)return this.queue.push(...r.slice(1)),r[0]}throw new Je(`${e}: no response within ${this.timeoutMs}ms`+(this.buffer.pending?` (partial data: ${this.buffer.pending.slice(0,60)})`:``))}readWithTimeout(e){return e<=0?Promise.resolve(null):new Promise((t,n)=>{let r=!1,i=setTimeout(()=>{r||(r=!0,t(null))},e);this.transport.read().then(e=>{r||(r=!0,clearTimeout(i),t(e))},e=>{r||(r=!0,clearTimeout(i),n(e))})})}async expectAck(e,t){let n=await this.send(e);if(!Ze(n))throw new Je(`${t}: expected "ok~" but device sent "${n}"`,n)}check(){return this.exchange(async()=>Qe(await this.send(`CHCK`),`CHCK`))}requestGlobalSettings(){return this.exchange(async()=>(await this.expectAck(`DREQ`,`DREQ`),Qe(await this.send(`globalSettings`),`DREQ globalSettings`)))}requestBankSettings(e){return this.exchange(async()=>(await this.expectAck(`DREQ`,`DREQ`),Qe(await this.send(`bankSettings,${e}`),`DREQ bankSettings,${e}`)))}transferGlobalSettings(e){return this.exchange(async()=>{await this.expectAck(`DTXR`,`DTXR`),await this.expectAck(`globalSettings`,`DTXR globalSettings`),await this.expectAck(JSON.stringify(e),`DTXR globalSettings payload`)})}transferBankSettings(e,t){return this.exchange(async()=>{await this.expectAck(`DTXR`,`DTXR`),await this.expectAck(`bankSettings,${e}`,`DTXR bankSettings,${e}`),await this.expectAck(JSON.stringify(t),`DTXR bankSettings,${e} payload`)})}control(...e){return this.exchange(async()=>{await this.expectAck(`CTRL`,`CTRL`),await this.expectAck(JSON.stringify({command:e}),`CTRL payload`)})}async savePresets(){await this.control(`savePresets`)}async goToBank(e){await this.control({goToBank:e})}async restart(){await this.control(`restart`)}async readFullConfig(e={}){let t=e.bankCount??128,n=await this.check(),r=await this.requestGlobalSettings(),i=[];for(let n=0;n<t;n++)i.push(await this.requestBankSettings(n)),e.onProgress?.(n+1,t);return{deviceSettings:n,globalSettings:r,bankSettings:i}}async writeFullConfig(e,t={}){let n=e.bankSettings??[],r=Math.min(t.bankCount??n.length,n.length);await this.transferGlobalSettings(e.globalSettings);for(let e=0;e<r;e++)await this.transferBankSettings(e,n[e]),t.onProgress?.(e+1,r);t.save!==!1&&await this.savePresets()}async close(){await this.transport.close?.()}},et=class{constructor(e){this.reader=null,this.decoder=new TextDecoder,this.port=e}async write(e){let t=this.port.writable.getWriter();try{await t.write(new TextEncoder().encode(e))}finally{t.releaseLock()}}async read(){this.reader||=this.port.readable.getReader();let{value:e,done:t}=await this.reader.read();return t?null:this.decoder.decode(e,{stream:!0})}async close(){if(this.reader){try{this.reader.releaseLock()}catch{}this.reader=null}}},tt=115200;function K(e){return`0x`+e.toString(16).toUpperCase().padStart(2,`0`)}var q=new class{constructor(){this.midiAccess=null,this.listeners=new Set,this.isSupported=typeof navigator<`u`&&`requestMIDIAccess`in navigator}async init(){if(!this.isSupported)return!1;try{return this.midiAccess=await navigator.requestMIDIAccess({sysex:!0}),this.midiAccess.onstatechange=()=>{this.notifyListeners()},!0}catch(e){return console.warn(`Web MIDI Access denied or unavailable:`,e),!1}}onStateChange(e){return this.listeners.add(e),()=>this.listeners.delete(e)}notifyListeners(){this.listeners.forEach(e=>e())}getHardwareNodes(e){let t=[],n=this.getDetectedMidiPorts(),r=z[e.controllerId],i=e.brainId===`scribble`?`Pirate MIDI Scribble`:r?r.name:`Controller`,a=n.find(t=>t.name.toLowerCase().includes(e.brainId)||t.name.toLowerCase().includes(e.controllerId));return t.push({id:e.brainId===`scribble`?`scribble`:e.controllerId,name:i,kind:`USB-C MIDI`,port:a?a.portName:`USB MIDI Port 1`,canRead:!0,canListen:!1}),e.rig.forEach(r=>{let i=R[r];if(!i)return;let a=n.find(e=>e.name.toLowerCase().includes(r));t.push({id:r,name:i.name,kind:`TRS MIDI`,port:a?a.portName:`MIDI Out Ch ${e.channels[r]||1}`,canRead:!1,canListen:!0})}),t}getDetectedMidiPorts(){if(!this.midiAccess)return[];let e=[];return this.midiAccess.inputs.forEach(t=>{e.push({id:t.id,name:t.name||`Unknown Device`,portName:t.name||t.id})}),e}async openDeviceApi(e){if(typeof navigator>`u`||!(`serial`in navigator))return console.warn(`Web Serial is unavailable — the Device API needs Chrome or Edge on desktop.`),null;let t=navigator.serial,n=null,r=await t.getPorts();if(r.length>0?n=r[0]:e&&(n=await t.requestPort()),!n)return null;if(!n.readable||!n.writable)try{await n.open({baudRate:tt})}catch(e){if(e?.name!==`InvalidStateError`&&!String(e?.message||``).includes(`already open`))throw e}return new $e(new et(n))}async requestLiveSerialConfig(e={}){let t=null;try{return t=await this.openDeviceApi(!0),t?await t.readFullConfig(e):null}catch(e){return console.warn(`Scribble read failed:`,e),null}finally{await t?.close()}}async readLiveDeviceConfig(e,t={}){if(e!==`scribble`)return null;let n=null;try{return n=await this.openDeviceApi(!1),n?await n.readFullConfig(t):null}catch(e){return console.warn(`Scribble read failed:`,e),null}finally{await n?.close()}}async writeLiveDeviceConfig(e,t={}){let n=null;try{return n=await this.openDeviceApi(!0),n?(await n.writeFullConfig(e,t),!0):!1}catch(e){return console.warn(`Scribble write failed:`,e),!1}finally{await n?.close()}}sendControlChange(e,t,n){if(!this.midiAccess)return;let r=176|e-1&15;this.midiAccess.outputs.forEach(e=>{try{e.send([r,t&127,n&127])}catch{}})}},nt=176;function J(e,t){let n=V.getDevice(e.device),r=V.getControl(e.device,e.control),i=t&&t[e.device]?t[e.device]:n?.midiChannel||1,a=e.value??127,o=r?.label||e.control;if(e.value!==null&&e.value!==void 0&&r){let t=V.valueOptionsFor(r).find(t=>t.value===e.value);t&&(o+=` · `+t.label)}let s=r?.cc||0,c=nt+(i-1);return{label:o,deviceId:n?.id||e.device,deviceName:n?.name||e.device,accent:n?.accent||`#ffffff`,channel:i,cc:s,value:a,message:{statusByte:c,dataByte1:s,dataByte2:a}}}function rt(e,t){if(!t)return null;let n=W[e];if(!n)return null;if(n.colors===null)return t;if(!n.colors.length)return null;if(n.colors.includes(t))return t;let r=Ge[t];return r&&n.colors.includes(r)?r:n.colors[0]}function it(e){let t={press:`Press`,hold:`Long Press`,double:`Double Tap`},n=[];return e.banks.slice(0,3).forEach((r,i)=>{Object.keys(r).forEach(a=>{let o={};if(B.forEach(n=>{let i=r[a][n.id];i.length&&(o[t[n.id]]=i.slice(0,6).map(t=>{let n=J(t,e.channels);return{type:`Control Change`,channel:n.channel,cc:n.cc,value:n.value}}))}),Object.keys(o).length){let t=`${i}:${a}`,r=e.naming&&e.naming[t]||{},s=r.name?r.name.slice(0,8):a,c=rt(`mc3`,r.color||null);n.push({bank:i+1,preset:a,name:s,ledColour:c,actions:o})}})}),{device:`Morningstar MC3`,schema:`stomp-stacks/mc3@1`,presets:n}}var at=class{constructor(){this.id=`mc3`,this.name=`Morningstar MC3`}compileExport(e){let t=it(e);return{filename:`mc3-preset-${e.controllerId}.json`,mimeType:`application/json`,content:JSON.stringify(t,null,2)}}compilePreview(e){let t=it(e);return JSON.stringify(t,null,2).split(`
`).map(e=>({text:e||` `}))}};function ot(e,t){e.banks.forEach((e,n)=>{Object.keys(e).forEach((r,i)=>{B.forEach(a=>{let o=e[r][a.id];o.length&&t(n,r,i,a,o)})})})}var st={usb:!0,ble:!0,midi1:!0};function ct(e){let t=[];for(let n=0;n<128;n++){let r=n<e.banks.length,i=`Preset ${n+1}`,a=`Second. ${n+1}`,o=0,s=[];if(r){let t=e.banks[n],r=new Set,c=[];if(Object.keys(t).forEach(n=>{B.forEach(({id:i})=>{t[n][i].forEach(t=>{let n=J(t,e.channels);r.add(n.deviceName.toUpperCase()),c.length<2&&c.push(`${n.deviceName} ${n.label}`),o||=V.getDeviceAccentColorInt(t.device),s.push({statusByte:n.message.statusByte,dataByte1:n.message.dataByte1,dataByte2:n.message.dataByte2,outputs:{...st}})})})}),s.length>0){let e=Array.from(r);i=e.length?e.join(` + `):`BANK ${n+1}`,a=c.join(` · `)||`Bank ${n+1}`}}let c=s.slice(0,8);t.push({bankId:n,bankName:i.slice(0,17),secondaryText:a.slice(0,17),colourOverride:s.length>0,colour:s.length>0?o||582655:0,textColourOverride:s.length>0,textColour:s.length>0?16777215:0,midiValueDisplayOverride:!1,midiValueDisplay:s.length>0?`valueOnly`:`none`,midiValueDisplayCC:0,bpm:120,switches:[{pressMessages:{numMessages:0,messages:[]},holdMessages:{numMessages:0,messages:[]}},{pressMessages:{numMessages:0,messages:[]},holdMessages:{numMessages:0,messages:[]}}],customMessages:{numMessages:0,messages:[]},presetMessages:{numMessages:c.length,messages:c}})}return{deviceSettings:{deviceModel:`Scribble`,firmwareVersion:`1.0.1`,hardwareVersion:`1.x.0`,deviceName:`Scribble`,uId:0x9070692f06d8,profileId:0},globalSettings:{deviceName:`Scribble`,currentBank:0,lightMode:`dark`,mainColour:15199215,textColour:0,displayBrightness:100,midiChannel:0,globalBpm:120,midiOutPortMode:`midiOutA`,pcBankOutputs:{usbd:1,ble:1,midi1:1},clockMode:`external`,clockDisplayType:`bpm`,usbdThruHandles:{usbd:!0,ble:!0,midi1:!0},bleThruHandles:{usbd:!0,ble:!0,midi1:!0},midi1ThruHandles:{usbd:!0,ble:!0,midi1:!0},midiClockOutHandles:{usbd:!0,ble:!0,midi1:!0},switches:[{mode:`pressPresetDown`,pressMessages:{numMessages:0,messages:[]},holdMessages:{numMessages:0,messages:[]}},{mode:`pressPresetUp`,pressMessages:{numMessages:0,messages:[]},holdMessages:{numMessages:0,messages:[]}}],customMessages:{numMessages:0,messages:[]},presetUpCC:1,presetDownCC:2,goToPresetCC:3,globalCustomMessagesCC:17,presetCustomMessagesCC:16,midiValueDisplay:`valueOnly`,midiValueDisplayCC:7,wirelessType:`ble`,bleMode:`server`,mainTextResize:!1,kemperPlayerMode:!1,useStaticIp:!1,staticIp:`0.0.0.0`,gatewayIp:`0.0.0.0`},bankSettings:t}}function lt(e,t,n,r,i){let a=e?.switches?.[t]||{},o=e?.bankName||e?.presetName||e?.name||e?.label||e?.strip?.name||a?.name||a?.label||a?.presetName||a?.bankName||a?.strip?.name||``,s=e?.secondaryText||e?.secondary||e?.description||e?.strip?.secondary||a?.secondaryText||a?.secondary||a?.description||a?.strip?.secondary||``;return o=typeof o==`string`?o.trim():``,s=typeof s==`string`?s.trim():``,o||(n.length>0?(o=Array.from(new Set(n.map(e=>{let t=V.getDevice(e.device);return t?t.name.toUpperCase():e.device.toUpperCase()}))).join(` + `),s||=n.map(e=>{let t=V.getDevice(e.device)?.controls.find(t=>t.id===e.control);return t?t.short||t.label:e.control}).join(` · `)):o=`Preset ${r*4+t+1}`),{presetName:o,secondaryText:s}}function ut(e,t,n=[`A`,`B`,`C`,`D`]){let r=[],i={};Object.keys(t).forEach(e=>{i[t[e]]=e});let a=Object.keys(t)[0]||`blooper`;function o(e){let t=[];return Array.isArray(e)&&e.forEach(e=>{let n=0,r=0,o=127;if(Array.isArray(e))n=e[0]||0,r=e[1]||0,o=e[2]??127;else if(e&&typeof e==`object`){if(typeof e.smartType==`string`)return;n=e.statusByte||0,r=e.dataByte1||0,o=e.dataByte2??127}let s=(n&15)+1,c=i[s]||a,l=V.getDevice(c);if(!l)return;let u=l.controls.find(e=>e.cc===r)||l.controls[0];u&&t.push({device:c,control:u.id,value:o===127&&u.type===`foot`?null:o})}),t}if(Array.isArray(e?.macros)&&e.macros.length>0)return e.macros.forEach(e=>{let t=0,i=`A`;if(e.trigger){if(typeof e.trigger.bank==`number`&&(t=Math.max(0,e.trigger.bank-1)),typeof e.trigger.cc==`number`){let t=e.trigger.cc-80;t>=0&&t<n.length&&(i=n[t])}else typeof e.trigger.action==`string`&&(i=e.trigger.action)}let a=Math.max(0,n.indexOf(i)),s=o(e.messages||[]),c=lt(e,a,s,t);r.push({bankIndex:t,key:i,presetName:c.presetName,secondaryText:c.secondaryText,steps:s})}),r;let s=Array.isArray(e?.bankSettings)?e.bankSettings:Array.isArray(e?.presetSettings)?e.presetSettings:[];if(s.length>0&&(s.forEach((e,t)=>{let i=typeof e.bankId==`number`?Math.floor(e.bankId/4):Math.floor(t/4),a=(typeof e.bankId==`number`?e.bankId:t)%n.length,s=n[a]||`A`,c=e.presetMessages?.messages||[],l=e.customMessages?.messages||[],u=e.switches?.[a]?.pressMessages?.messages||[],d=e.messages||[],f=o([...Array.isArray(c)?c:[],...Array.isArray(l)?l:[],...Array.isArray(u)?u:[],...Array.isArray(d)?d:[]]),p=lt(e,a,f,i),ee=p.presetName&&!p.presetName.match(/^Preset \d+$/i),m=p.secondaryText&&!p.secondaryText.match(/^Second\. \d+$/i);(ee||m||f.length>0)&&r.push({bankIndex:i,key:s,presetName:p.presetName,secondaryText:p.secondaryText,steps:f})}),r.length>0))return r;let c=[{name:`CLOUD`,secondary:`Ambient Delay`},{name:`GLITCH POP`,secondary:`Microloop Granular`},{name:`LOFI DRIFT`,secondary:`Tape Pitch Wobble`},{name:`TAPE TRIP`,secondary:`Echo Reverse`},{name:`BLOOPER`,secondary:`Loop Speed + Pitch`},{name:`MOOD`,secondary:`Reverb + Slip`},{name:`EL CAPISTAN`,secondary:`Tape Echo`},{name:`CHROMA`,secondary:`Chorus Flange`}];for(let e=0;e<4;e++)n.forEach((t,n)=>{let i=e*4+n,o=a,s=V.getDevice(o),l=s?.controls[n%(s?.controls.length||1)]||s?.controls[0],u=s&&l?[{device:o,control:l.id,value:64}]:[],d=c[i%c.length];r.push({bankIndex:e,key:t,presetName:d.name,secondaryText:d.secondary,steps:u})});return r}var dt=class{constructor(){this.id=`scribble`,this.name=`Pirate MIDI Scribble`}compileExport(e){let t=ct(e);return{filename:`scribble.json`,mimeType:`application/json`,content:JSON.stringify(t,null,2)}}compilePreview(e){let t=ct(e);return JSON.stringify(t,null,2).split(`
`).map(e=>({text:e||` `}))}},Y=8;function ft(e,t){return e?e.length<=t?e:e.slice(0,t):``}function pt(e){let t=V.getController(e);return{controllerId:e,brainId:`scribble`,banks:G.createBanks(e),bank:0,selectedKey:t.keys[0],action:`press`,browseDevice:Re[0],face:`photo`,popoverControlId:null,compileOpen:!1,settingsOpen:!1,controllerPickerOpen:!1,brainPickerOpen:!1,addPedalOpen:!1,confirmRemovePedal:null,channelPickerOpen:!1,colorPickerOpen:!1,targetId:`scribble`,rig:[`blooper`,`mood`,`elcap`],channels:{blooper:1,mood:2,elcap:3},naming:{},sheetOpen:!1,connectOpen:!1,readOpen:!1,readData:null,conn:{},listening:null,heard:null,offsets:{},monitorOn:!1,log:[],seq:0}}var mt=class extends EventTarget{constructor(...e){super(...e),this.state=pt(`chocolate`)}set(e){this.state={...this.state,...e},this.dispatchEvent(new Event(`change`))}get activeStack(){let{banks:e,bank:t,selectedKey:n,action:r}=this.state;return G.getActiveStack(e,t,n,r)}get totalAssigned(){return G.countTotalAssignedSteps(this.state.banks)}nextFreeChannel(e=this.state.rig,t=this.state.channels){return V.findNextFreeChannel(e,t)}addPedal(e){if(this.state.rig.includes(e)){this.set({addPedalOpen:!1,browseDevice:e});return}let t=[...this.state.rig,e],n={...this.state.channels};n[e]||(n[e]=V.findNextFreeChannel(t.filter(t=>t!==e),n)),this.set({rig:t,channels:n,browseDevice:e,addPedalOpen:!1,popoverControlId:null})}dropPedal(e){if(this.state.rig.length<=1)return;let t=this.state.rig.filter(t=>t!==e),n=this.state.browseDevice===e?t[0]:this.state.browseDevice;this.set({rig:t,browseDevice:n,channelPickerOpen:!1,popoverControlId:null,confirmRemovePedal:null})}setPedalChannel(e,t){let n={...this.state.channels,[e]:t};this.set({channels:n,channelPickerOpen:!1})}toggleChannelPicker(){this.set({channelPickerOpen:!this.state.channelPickerOpen})}setBrain(e){this.set({brainId:e,brainPickerOpen:!1})}openBrainPicker(){this.set({brainPickerOpen:!0,channelPickerOpen:!1})}closeBrainPicker(){this.set({brainPickerOpen:!1})}openAddPedal(){this.set({addPedalOpen:!0,channelPickerOpen:!1})}closeAddPedal(){this.set({addPedalOpen:!1})}setConfirmRemove(e){this.set({confirmRemovePedal:e,channelPickerOpen:!1})}setTarget(e){this.set({targetId:e})}clickControl(e){if(e.type!==`foot`){this.set({popoverControlId:this.state.popoverControlId===e.id?null:e.id,sheetOpen:!0});return}this.addStep(e.id,null)}addStep(e,t){let{banks:n,bank:r,selectedKey:i,action:a,browseDevice:o}=this.state,s=G.addOrToggleStep(n,r,i,a,o,e,t,Y);this.set({banks:s,popoverControlId:null,sheetOpen:!0})}removeStep(e){let{banks:t,bank:n,selectedKey:r,action:i}=this.state,a=G.removeStep(t,n,r,i,e);this.set({banks:a})}moveStep(e,t){let{banks:n,bank:r,selectedKey:i,action:a}=this.state,o=G.moveStep(n,r,i,a,e,t);this.set({banks:o})}selectSwitch(e){this.set({selectedKey:e,popoverControlId:null})}selectBank(e){this.set({bank:e,popoverControlId:null})}selectAction(e){this.set({action:e,popoverControlId:null})}setBrowseDevice(e){this.set({browseDevice:e,popoverControlId:null,channelPickerOpen:!1})}closePopover(){this.set({popoverControlId:null})}setFace(e){this.set({face:e,popoverControlId:null})}openSettings(){this.set({settingsOpen:!0})}closeSettings(){this.set({settingsOpen:!1})}openControllerPicker(){this.set({controllerPickerOpen:!0})}closeControllerPicker(){this.set({controllerPickerOpen:!1})}openCompile(){this.set({compileOpen:!0})}closeCompile(){this.set({compileOpen:!1})}toggleSheet(){this.set({sheetOpen:!this.state.sheetOpen})}setSheet(e){this.set({sheetOpen:e})}toggleColorPicker(){this.set({colorPickerOpen:!this.state.colorPickerOpen})}closeColorPicker(){this.set({colorPickerOpen:!1})}namingTargets(){let e=[this.state.controllerId];return this.state.brainId===`scribble`&&e.push(`scribble`),e.filter(e=>W[e]).map(e=>({...W[e]}))}displayTargets(){return this.namingTargets().filter(e=>e.name>0)}sharedColors(){let e=this.namingTargets().filter(e=>e.colors===null||e.colors.length>0);return e.length?H.map(e=>e[0]).filter(t=>e.every(e=>e.colors===null||e.colors&&e.colors.includes(t))):[]}autoName(e=this.state.bank,t=this.state.selectedKey){let n=this.state.banks[e]?.[t];if(!n)return``;let r=null,i=0;if(B.forEach(e=>n[e.id].forEach(e=>{i++,r||=e})),!r)return``;let a=r,o=V.getDevice(a.device);if(!o)return``;let s=V.getControl(a.device,a.control),c=this.displayTargets().reduce((e,t)=>Math.min(e,t.name),24);return ft(i>1?`${o.name} +${i-1}`:`${o.name} ${s?s.short:``}`,c)}autoSecondary(e=this.state.bank,t=this.state.selectedKey){let n=this.state.banks[e]?.[t];if(!n)return``;let r=[];return B.forEach(e=>{n[e.id].length&&r.push(`${n[e.id].length} on ${e.label}`)}),r.join(` · `)}ident(e=this.state.bank,t=this.state.selectedKey){let n=`${e}:${t}`,r=this.state.naming[n]||{},i=this.autoName(e,t),a=this.autoSecondary(e,t),o=r.color||null,s=o?U[o]:`#16323d`;return{name:r.name!=null&&r.name!==``?r.name:i,secondary:r.secondary||``,color:o,textColor:r.textColor||(Ke(s)?`cream`:`ink`),autoText:!r.textColor,raw:r,auto:i,autoSec:a}}setIdent(e,t=this.state.bank,n=this.state.selectedKey){let r=`${t}:${n}`,i={...this.state.naming,[r]:{...this.state.naming[r],...e}};this.set({naming:i})}colorFor(e,t){if(!t)return null;let n=W[e];if(!n)return null;if(n.colors===null)return t;if(!n.colors.length)return null;if(n.colors.includes(t))return t;let r=Ge[t];return r&&n.colors.includes(r)?r:n.colors[0]}switchController(e){let t=V.getController(e);this.set({controllerId:e,banks:G.createBanks(e),bank:0,selectedKey:t.keys[0],controllerPickerOpen:!1,popoverControlId:null,colorPickerOpen:!1})}openConnect(){this.set({connectOpen:!0})}closeConnect(){this.set({connectOpen:!1})}pushLog(e){let t=this.state.seq+1,n={n:t,...e},r=[...this.state.log,n].slice(-60);this.set({seq:t,log:r})}toggleConn(e){let t=!!this.state.conn[e],n={...this.state.conn,[e]:!t},r=t&&this.state.listening===e?null:this.state.listening;this.set({conn:n,listening:r});let i=q.getHardwareNodes(this.state).find(t=>t.id===e);this.pushLog({text:(t?`closed `:`opened `)+(i?i.port:e),sub:i?i.name:e,tone:t?`warn`:`ok`})}stompTest(){let e=this.state,t=e.banks[e.bank]?.[e.selectedKey]?.[e.action]||[],n=B.find(t=>t.id===e.action),r=n?n.label:e.action;if(!t.length){this.pushLog({text:`switch ${e.selectedKey} · ${r}`,sub:`nothing stacked here`,tone:`warn`});return}this.pushLog({text:`▸ switch ${e.selectedKey} · ${r}`,sub:`${t.length} ${t.length===1?`message`:`messages`} out`,tone:`trig`}),t.forEach((t,n)=>{setTimeout(()=>{let n=R[t.device];if(!n)return;let r=n.controls.find(e=>e.id===t.control),i=e.channels[t.device]||1,a=(r?r.cc:10)+(e.offsets[t.device]||0),o=t.value===null?127:t.value,s=!!e.conn[t.device];s&&q.sendControlChange(i,a,o),this.pushLog({text:`${K(176+i-1)} ${K(a)} ${K(o)}`,sub:s?`${n.name} · ${r?r.label:t.control}`:`${n.name} never answered — is it plugged in?`,tone:s?`out`:`warn`})},110*n)})}simScribblePresets(){let e=this.state,t=e.rig;if(!t.length)return[];let n=[1,2,3,5,8,13,17,21,34,55,64,89,127],r=H.map(e=>e[0]);return n.map((n,i)=>{let a=t[i%t.length],o=R[a],s=o?o.controls.filter(e=>e.type===`foot`):[],c=s[i%Math.max(s.length,1)]||(o?o.controls[0]:null),l=c?[{device:a,control:c.id,value:null}]:[];if(i%3!=2&&t.length>1){let e=t[(i+1)%t.length],n=R[e],r=n?n.controls.filter(e=>e.type===`knob`):[],a=r[i%Math.max(r.length,1)]||(n?n.controls[0]:null);a&&l.push({device:e,control:a.id,value:16*(i%7+1)})}if(i%4==1&&t.length>2){let e=t[(i+2)%t.length],n=R[e];if(n&&n.controls.length){let t=n.controls[(i+1)%n.controls.length];l.push({device:e,control:t.id,value:127})}}return{n,label:`${o?o.name.split(` `)[0].toUpperCase():`PEDAL`} ${c?(c.short||c.label||``).split(` `)[0]:``}`.slice(0,12).trim(),second:`${o?o.name.toLowerCase():a} · ch ${e.channels[a]||1}`,color:r[i%r.length],steps:l}})}async readFrom(e,t){let n=this.state,r=z[n.controllerId],i=r?r.keys:[`A`,`B`,`C`,`D`],a=!t;if(this.set({readOpen:!0,readData:{from:e,presets:[],dest:{},filter:``,allPresets:[],readingHardware:a,scanned:0,total:128,found:0},connectOpen:!1}),a){this.pushLog({text:`querying ${e}...`,sub:`sending Web Serial / MIDI query to device`,tone:`trig`});for(let e=1;e<=16;e++)setTimeout(()=>{if(!this.state.readData||!this.state.readData.readingHardware)return;let t=Math.round(8*e);this.set({readData:{...this.state.readData,scanned:t,found:Math.min(t,13)}})},95*e)}let o=t;o||=await q.readLiveDeviceConfig(e)??void 0;let s=o?ut(o,n.channels,i):[],c=H.map(e=>e[0]),l=s.length?s.map((e,t)=>({n:e.bankIndex*4+(e.key===`A`?1:e.key===`B`?2:e.key===`C`?3:4),label:e.presetName,second:e.secondaryText||`${R[e.steps[0]?.device]?.name||`pedal`} · ch ${n.channels[e.steps[0]?.device]||1}`,color:c[t%c.length],steps:e.steps})):this.simScribblePresets(),u=s.map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0})),d=q.getHardwareNodes(n).find(t=>t.id===e);this.pushLog({text:`read ${d?d.name:e}`,sub:o?`${l.length} device presets loaded live from physical Scribble`:`live hardware query finished — select scribble.json file if USB CDC requires manual grant`,tone:o?`ok`:`warn`}),this.set({readData:{from:e,presets:l,dest:{},filter:``,allPresets:u,readingHardware:!1,scanned:128,total:128,found:l.length}})}async readLiveUsbSerial(){this.set({readOpen:!0,readData:{from:`scribble`,presets:[],dest:{},filter:``,allPresets:[],readingHardware:!0,scanned:0,total:128,found:0}});for(let e=1;e<=16;e++)setTimeout(()=>{if(!this.state.readData||!this.state.readData.readingHardware)return;let t=Math.round(8*e);this.set({readData:{...this.state.readData,scanned:t,found:Math.min(t,13)}})},95*e);let e=await q.requestLiveSerialConfig(),t=this.state,n=z[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`],i=e?ut(e,t.channels,r):[],a=H.map(e=>e[0]),o=i.length?i.map((e,n)=>({n:e.bankIndex*4+(e.key===`A`?1:e.key===`B`?2:e.key===`C`?3:4),label:e.presetName,second:e.secondaryText||`${R[e.steps[0]?.device]?.name||`pedal`} · ch ${t.channels[e.steps[0]?.device]||1}`,color:a[n%a.length],steps:e.steps})):this.simScribblePresets(),s=i.map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0}));this.pushLog({text:`read USB device`,sub:e?`${o.length} presets loaded live from physical Scribble`:`no USB serial data received — select scribble.json file`,tone:e?`ok`:`warn`}),this.set({readData:{from:`scribble`,presets:o,dest:{},filter:``,allPresets:s,readingHardware:!1,scanned:128,total:128,found:o.length}})}async connectAndImportScribble(){this.pushLog({text:`connecting to Scribble...`,sub:`requesting USB device permission`,tone:`trig`});let e=await q.requestLiveSerialConfig(),t=this.state,n=z[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`];if(e){let n=ut(e,t.channels,r).map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0}));if(n.length>0){this.loadPresetsIntoBanks(n),this.pushLog({text:`Scribble connected & synced`,sub:`imported ${n.length} active hardware presets`,tone:`ok`}),this.set({connectOpen:!1});return}}this.readFrom(`scribble`,e||void 0)}loadScribbleFile(e){this.readFrom(`scribble`,e)}setReadFilter(e){this.state.readData&&this.set({readData:{...this.state.readData,filter:e}})}setReadDest(e,t){if(!this.state.readData)return;let n={...this.state.readData.dest};if(!t)delete n[e];else{let r=t.split(`:`);n[e]={key:r[0],action:r[1],mode:n[e]?.mode||`replace`}}this.set({readData:{...this.state.readData,dest:n}})}setReadDestMode(e,t){if(!this.state.readData||!this.state.readData.dest[e])return;let n={...this.state.readData.dest,[e]:{...this.state.readData.dest[e],mode:t}};this.set({readData:{...this.state.readData,dest:n}})}applyPresets(){let e=this.state.readData;if(!e||!e.presets)return;let t=e.presets.filter(t=>e.dest[t.n]).map(t=>({p:t,d:e.dest[t.n]})),n=this.state,r=n.bank,i=n.banks.map(e=>{let t={};return Object.keys(e).forEach(n=>{t[n]={press:[...e[n].press],hold:[...e[n].hold],double:[...e[n].double]}}),t}),a={...n.naming};t.forEach(({p:e,d:t})=>{let n=i[r]?.[t.key];if(n&&(t.mode===`add`?n[t.action]=[...n[t.action],...e.steps.map(e=>({...e}))].slice(0,Y):n[t.action]=e.steps.map(e=>({...e})),t.mode===`replace`)){let n=`${r}:${t.key}`;a[n]={name:e.label,secondary:e.second,color:e.color}}}),this.pushLog({text:t.length?`pulled ${t.length} ${t.length===1?`preset`:`presets`} in`:`took nothing`,sub:t.length?t.map(e=>`p${String(e.p.n).padStart(3,`0`)} → ${e.d.key}`).join(`, `):`left the rig as it was`,tone:`ok`}),this.set({banks:i,naming:a,readOpen:!1,readData:null})}togglePresetSelection(e){if(!this.state.readData||!this.state.readData.allPresets)return;let t=this.state.readData.allPresets.map(t=>t.id===e?{...t,selected:!t.selected}:t);this.set({readData:{...this.state.readData,allPresets:t}})}selectAllReadPresets(e){if(!this.state.readData||!this.state.readData.allPresets)return;let t=this.state.readData.allPresets.map(t=>({...t,selected:e}));this.set({readData:{...this.state.readData,allPresets:t}})}importSinglePreset(e){let t=this.state,n=t.bank,r=t.selectedKey,i=t.banks.map((t,i)=>{if(i!==n)return t;let a={...t};return a[r]={...a[r],press:[...e.steps]},a}),a=`${n}:${r}`,o={...t.naming,[a]:{name:e.presetName,secondary:e.secondaryText}};this.pushLog({text:`imported preset "${e.presetName}"`,sub:`loaded into Bank ${n+1} - Switch ${r}`,tone:`ok`}),this.set({banks:i,naming:o})}loadPresetsIntoBanks(e){if(!e||!e.length)return;let t=this.state,n=z[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`],i=Math.max(...e.map(e=>e.bankIndex),0),a=Math.max(t.banks.length,i+1),o=[];for(let e=0;e<a;e++){let n={...t.banks[e]||G.createBanks(t.controllerId)[0]};Object.keys(n).forEach(e=>{n[e]={press:[...n[e].press],hold:[...n[e].hold],double:[...n[e].double]}}),o.push(n)}let s={...t.naming};e.forEach(e=>{if(e.bankIndex<o.length&&r.includes(e.key)){o[e.bankIndex][e.key]&&(o[e.bankIndex][e.key].press=[...e.steps]);let t=`${e.bankIndex}:${e.key}`;s[t]={name:e.presetName,secondary:e.secondaryText}}});let c={...t.conn,scribble:!0};this.set({banks:o,naming:s,conn:c,readOpen:!1,readData:null})}importSelectedDevicePresets(){let e=this.state.readData;if(!e||!e.allPresets||!e.allPresets.length)return;let t=e.allPresets.filter(e=>e.selected);t.length&&(this.loadPresetsIntoBanks(t),this.pushLog({text:`imported ${t.length} presets from Scribble`,sub:`loaded into Stomp Stacks banks & macro stacks`,tone:`ok`}))}pickReadRow(e,t){}applyRead(){this.importSelectedDevicePresets()}cancelRead(){this.set({readOpen:!1,readData:null})}listenTo(e){if(!this.state.conn[e])return;this.set({listening:e,heard:null});let t=R[e];if(!t)return;let n={blooper:4,mood:0,elcap:-2}[e]||0,r=t.controls[2]||t.controls[0],i=r?r.cc:10,a=this.state.offsets[e]||0;setTimeout(()=>{if(this.state.listening!==e)return;let o=i+a+n,s=i+a;this.set({heard:{pedal:e,control:r.id,cc:o,expect:s,drift:n}});let c=this.state.channels[e]||1;this.pushLog({text:`${K(176+c-1)} ${K(o)} 7F`,sub:`${t.name} sent this when you moved ${r.short||r.label}`,tone:`in`})},1100)}acceptDrift(){let e=this.state.heard;if(!e)return;let t=R[e.pedal],n={...this.state.offsets,[e.pedal]:(this.state.offsets[e.pedal]||0)+e.drift};this.set({offsets:n,heard:null,listening:null}),this.pushLog({text:`shifted ${t?t.name:e.pedal} by ${e.drift>0?`+`:``}${e.drift}`,sub:`its whole map moves with it`,tone:`ok`})}dismissHeard(){this.set({heard:null,listening:null})}toggleMonitor(){this.set({monitorOn:!this.state.monitorOn})}clearLog(){this.set({log:[]})}},X=class{constructor(e,t){this.onChange=()=>this.host.requestUpdate(),this.host=e,this.store=t,e.addController(this)}hostConnected(){this.store.addEventListener(`change`,this.onChange)}hostDisconnected(){this.store.removeEventListener(`change`,this.onChange)}};function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var ht=class extends j{constructor(...e){super(...e),this.desktop=!1}static{this.styles=[P,F,o`
      :host {
        display: block;
      }
      .name-row {
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=z[e.controllerId],n=e.banks[e.bank],r=this.desktop?t.heightDesktop:t.height;return T`
      ...
      <div class="strip" style="height:${r}px">
        ...
        ${t.keys.map((r,i)=>{let a=e.selectedKey===r,o=0,s=new Set;B.forEach(({id:e})=>{n[r][e].forEach(e=>{o++,s.add(e.device)})});let c=s.size===1?R[[...s][0]].accent:s.size>1?`var(--mustard)`:`rgba(247,241,227,.16)`;return T`
            <button
              class="switch-wrap"
    ...
    `}};Z([N({attribute:!1})],ht.prototype,`store`,void 0),Z([N({type:Boolean,reflect:!0})],ht.prototype,`desktop`,void 0),ht=Z([M(`controller-graphic`)],ht);var gt=class extends j{static{this.styles=[P,F,I,o`
      :host {
        display: block;
        position: relative;
        overflow: visible;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=e.browseDevice,n=V.getDevice(t),r=e.channels[t]||(n?n.midiChannel:1);return T`
      <div class="wrap">
        <div class="row">
          ${e.rig.map(n=>{let r=V.getDevice(n);if(!r)return null;let i=t===n;return T`
              <span
                class="chip-wrap"
                ?active=${i}
    ...
    `}};Z([N({attribute:!1})],gt.prototype,`store`,void 0),gt=Z([M(`device-tabs`)],gt);var _t={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},vt=e=>(...t)=>({_$litDirective$:e,values:t}),yt=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}},bt=`important`,xt=` !important`,St=vt(class extends yt{constructor(e){if(super(e),e.type!==_t.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`},``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(xt);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?bt:``):n[e]=r}}return E}}),Q=class extends j{constructor(...e){super(...e),this.phone=!1,this.desktop=!1}static{this.styles=[P,F,o`
      :host {
        display: flex;
        flex: 1;
        min-width: 0;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=V.getDevice(e.browseDevice),n=e.face===`drawn`,r=this.store.activeStack,i={aspectRatio:n?`344/426`:`${t.pw}/${t.ph}`,width:this.phone?`100%`:`auto`,maxWidth:`100%`,height:this.phone?`auto`:`100%`};return this.desktop&&(i.maxHeight=n?`420px`:`600px`),T`
      <div class="canvas">
        ${this.desktop?T`
    ...
    `}renderControl(e,t,n,r,i){let a=[];r.forEach((n,r)=>{n.device===t.id&&n.control===e.id&&a.push(r+1)});let o=a.length>0,s=i===e.id,c=!n,l=c?e.px:e.x,u=c?e.py:e.y,d={position:`absolute`,left:`${l}%`,top:`${u}%`,transform:`translate(-50%,-50%)`,display:`flex`,alignItems:`center`,justifyContent:`center`,zIndex:String(s?12:6)};c?(d.width=`${e.ps}%`,d.aspectRatio=`1`):e.type===`foot`?(d.width=`18%`,d.aspectRatio=`1`):e.type===`toggle`?(d.width=`9%`,d.height=`11%`):(d.width=`14%`,d.aspectRatio=`1`),this.phone&&(d.minWidth=`44px`,d.minHeight=`44px`);let f;f=c?{display:`block`,width:`100%`,height:`100%`,borderRadius:`50%`,border:`2.5px ${s||o?`solid`:`dashed`} var(--ink)`,background:s?`#f7c948aa`:o?`#f7c94855`:`rgba(255,251,240,.28)`,boxShadow:s?`0 0 0 4px #f7c94866`:`none`,transition:`background 160ms ease, box-shadow 160ms cubic-bezier(.23,1,.32,1)`}:e.type===`toggle`?{display:`block`,width:`100%`,height:`100%`,borderRadius:`7px`,background:`var(--ink)`,border:`2.5px solid var(--ink)`}:{display:`block`,width:`100%`,height:`100%`,borderRadius:`50%`,background:`#fffbf0`,border:`2.5px solid var(--ink)`,boxShadow:s?`0 0 0 4px #f7c94866`:`2px 2px 0 var(--ink)`,transition:`box-shadow 160ms cubic-bezier(.23,1,.32,1)`};let p=c?{position:`absolute`,left:`50%`,bottom:`calc(100% + 6px)`,transform:`translateX(-50%)`,whiteSpace:`nowrap`,fontSize:`11px`,fontWeight:`600`,padding:`2px 8px`,borderRadius:`12px`,background:`var(--mustard)`,border:`2px solid var(--ink)`,color:`var(--ink)`,pointerEvents:`none`,opacity:s||o?`1`:`0`}:{position:`absolute`,left:`50%`,[e.type===`foot`?`bottom`:`top`]:e.type===`foot`?`calc(100% + 6px)`:`calc(100% + 5px)`,transform:`translateX(-50%)`,whiteSpace:`nowrap`,fontSize:`clamp(8px,3.2cqw,11px)`,fontWeight:`500`,color:`var(--ink)`,opacity:`.75`,pointerEvents:`none`};return T`
      ...
      >
        <span style=${St(f)}></span>
        <span style=${St(p)}>${e.short}</span>
        ${o?T`<span class="badge">${a.join(`,`)}</span>`:null}
      </button>
    `}};Z([N({attribute:!1})],Q.prototype,`store`,void 0),Z([N({type:Boolean,reflect:!0})],Q.prototype,`phone`,void 0),Z([N({type:Boolean,reflect:!0})],Q.prototype,`desktop`,void 0),Q=Z([M(`pedal-canvas`)],Q);function Ct(e){let t={};return e.banks.forEach(e=>{Object.keys(e).forEach(n=>{B.forEach(({id:r})=>{e[n][r].forEach(e=>{t[e.device]=!0})})})}),Object.keys(t)}function wt(e,t){let n={};return e.banks.forEach(e=>{Object.keys(e).forEach(r=>{B.forEach(({id:i})=>{e[r][i].forEach(e=>{e.device===t&&(n[e.control]=!0)})})})}),Object.keys(n)}function Tt(e){let t={};return Ct(e).forEach(n=>{let r=V.getDevice(n);if(!r)return;let i={};wt(e,n).forEach(e=>{let t=V.getControl(n,e);t&&(i[e]=t.cc)}),t[n]={name:r.name,channel:e.channels[n]||r.midiChannel,cc:i}}),{schema:`stomp-stacks/rig@1`,controller:e.controllerId,brain:e.brainId,pedals:t,banks:e.banks.map((t,n)=>{let r={};return Object.keys(t).forEach(i=>{let a={};if(B.forEach(e=>{t[i][e.id].length&&(a[e.id]=t[i][e.id].map(e=>({pedal:e.device,control:e.control,value:e.value===null||e.value===void 0?127:e.value})))}),Object.keys(a).length){let t=`${n}:${i}`,o=e.naming&&e.naming[t]||{};r[i]={name:o.name||``,secondary:o.secondary||``,color:o.color||null,textColor:o.textColor||`ink`,actions:a}}}),r})}}var Et=class{constructor(){this.id=`rig`,this.name=`Rig Schema JSON`}compileExport(e){let t=Tt(e);return{filename:`rig-stack-${e.controllerId}.json`,mimeType:`application/json`,content:JSON.stringify(t,null,2)}}compilePreview(e){let t=Tt(e);return JSON.stringify(t,null,2).split(`
`).map(e=>({text:e||` `}))}},Dt=class{constructor(){this.id=`labels`,this.name=`Printable Labels`}compileExport(e){let t=this.compilePreview(e);return{filename:`stomp-labels-${e.controllerId}.txt`,mimeType:`text/plain`,content:t.map(e=>e.text).join(`
`)}}compilePreview(e){let t=[],n=(e,n)=>{t.push({text:e===``?` `:e,...n})},r=V.getController(e.controllerId),i=V.getBrain(e.brainId);return n(`STOMP STACKS · ${r.name}`,{bold:!0}),n(`via ${i.full.toLowerCase()}`,{muted:!0}),ot(e,(t,r,i,a,o)=>{let s=`${t}:${r}`,c=e.naming&&e.naming[s]||{},l=c.name||`switch ${r}`;n(``),n(`${l}  ·  ${a.label}`,{bold:!0}),c.secondary&&n(c.secondary),n(`bank ${t+1} · switch ${r}${c.color?` · ${c.color}`:``}`,{muted:!0}),o.forEach((t,r)=>{let i=J(t,e.channels);n(`   ${r+1}. ${i.deviceName} — ${i.label}`)})}),t.length||n(`nothing stacked yet — go poke a pedal`,{muted:!0}),t}},Ot=e=>e.toString(16).toUpperCase().padStart(2,`0`),kt=class{constructor(){this.id=`trace`,this.name=`MIDI Trace Log`}compileExport(e){let t=this.compilePreview(e);return{filename:`midi-trace-${e.controllerId}.txt`,mimeType:`text/plain`,content:t.map(e=>e.text).join(`
`)}}compilePreview(e){let t=[],n=(e,n)=>{t.push({text:e===``?` `:e,...n})};return ot(e,(t,r,i,a,o)=>{n(`▸ bank ${t+1} · ${r} ${a.label}`,{bold:!0}),o.forEach(t=>{let r=J(t,e.channels);n(`    ${Ot(176+r.channel-1)} ${Ot(r.cc)} ${Ot(r.value)}    ${r.deviceName} ${r.label}`,{muted:!0})}),n(``)}),t.length||n(`nothing stacked yet — go poke a pedal`,{muted:!0}),t}},At={rig:new Et,mc3:new at,scribble:new dt,labels:new Dt,trace:new kt};function jt(e){let t=V.getBrain(e.brainId),n=V.getController(e.controllerId),r=[],i=0,a=0;ot(e,(e,n,r,o,s)=>{s.length>t.maxSteps&&(i++,s.length>a&&(a=s.length))}),i&&r.push({type:`warn`,text:`${i} stack${i===1?``:`s`} run to ${a} messages — ${t.full.toLowerCase()} sends ${t.maxSteps}${e.brainId===`none`?`. this is the case for a brain.`:`. trim them or move up.`}`}),e.banks.length>t.banks&&r.push({type:`warn`,text:`${n.name} has ${e.banks.length} banks; ${t.full.toLowerCase()} holds ${t.banks}.`}),e.brainId===`onboard`&&!n.onboard&&r.push({type:`warn`,text:`${n.name} can't hold stacks onboard — it only sends one message per switch.`});let o=Ct(e).filter(t=>!e.rig.includes(t));o.length&&r.push({type:`warn`,text:`${o.map(e=>V.getDevice(e)?.name||e).join(` + `)} ${o.length===1?`is`:`are`} stacked but no longer in the rig — those steps won't be sent.`}),V.detectChannelCollisions(e.rig,e.channels).forEach(({channel:e,devices:t})=>{r.push({type:`warn`,text:`${t.join(` + `)} are both on channel ${e} — their cc numbers will collide.`})}),e.targetId===`mc3`&&e.controllerId!==`mc3`&&r.push({type:`warn`,text:`building an mc3 preset, but the rig is set to ${n.name}.`}),e.targetId===`scribble`&&e.brainId!==`scribble`&&r.push({type:`warn`,text:`building a scribble config, but the brain is set to ${t.full.toLowerCase()}.`});let s={state:e,namingTargets(){let t=[e.controllerId];return e.brainId===`scribble`&&t.push(`scribble`),t.filter(e=>W[e]).map(e=>({...W[e]}))},displayTargets(){return this.namingTargets().filter(e=>e.name>0)},sharedColors(){let e=this.namingTargets().filter(e=>e.colors===null||e.colors.length>0);return e.length?H.map(e=>e[0]).filter(t=>e.every(e=>e.colors===null||e.colors&&e.colors.includes(t))):[]}},c=[];e.banks.forEach((t,n)=>{Object.keys(t).forEach(r=>{let i=0;if(B.forEach(e=>{i+=t[r][e.id].length}),i){let t=`${n}:${r}`,i=e.naming&&e.naming[t]||{};c.push({name:i.name||``,secondary:i.secondary||``,color:i.color||null,raw:i})}})}),s.displayTargets().forEach(e=>{let t=c.filter(t=>t.raw.name&&t.name.length>e.name).length;if(t&&r.push({type:`warn`,text:`${t} ${t===1?`name is`:`names are`} longer than the ${e.label.toLowerCase()} shows (${e.name} characters) — ${t===1?`it reads`:`they read`} trimmed there.`}),!e.secondary){let t=c.filter(e=>e.secondary).length;t&&r.push({type:`warn`,text:`${t} second ${t===1?`line has`:`lines have`} nowhere to go on the ${e.label.toLowerCase()} — ${t===1?`it lands`:`they land`} on the label sheet instead.`})}});let l=s.sharedColors(),u={};return c.forEach(e=>{e.color&&(!l.length||!l.includes(e.color))&&(u[e.color]=!0)}),Object.keys(u).forEach(e=>{let t=e,n=s.namingTargets().filter(e=>e.colors&&e.colors.length&&!e.colors.includes(t));n.length&&r.push({type:`warn`,text:`${e} isn't in ${n.map(e=>e.label.toLowerCase()).join(` or `)}'s palette — those stacks fall back to a compatible color there.`})}),r.length||r.push({type:`ok`,text:`all clear — nothing collides, nothing overflows.`}),r}var Mt=class{static compile(e,t=e.targetId){let n=At[t]||At.rig;return{targetId:t,exportFile:n.compileExport(e),preview:n.compilePreview(e),diagnostics:jt(e)}}static getAdapter(e){return At[e]||At.rig}};Mt.compile;var $=class extends j{constructor(...e){super(...e),this.phone=!1,this.desktop=!1}static{this.styles=[P,F,I,o`
      :host {
        display: flex;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=e.banks[e.bank],n=this.store.activeStack,r=e.sheetOpen||!this.phone;this.phone?this.style.maxHeight=r?`56%`:`none`:this.style.maxHeight=``;let i=V.getDevice(e.browseDevice),a=e.popoverControlId?V.getControl(e.browseDevice,e.popoverControlId):null,o=this.store.ident(e.bank,e.selectedKey),s=this.store.sharedColors(),c=H.map(e=>e[0]).filter(e=>s.length>0&&!s.includes(e)),l=this.store.displayTargets().length>0||s.length>0,u=o.color?U[o.color]:`#16323d`,d=We[o.textColor],f=[];if(l&&(this.store.displayTargets().forEach(e=>{o.raw.name&&o.name.length>e.name&&f.push(`${e.label.toLowerCase()} shows “${o.name.slice(0,e.name)}”`),o.secondary&&!e.secondary?f.push(`${e.label.toLowerCase()} drops the second line`):o.secondary&&o.secondary.length>e.secondary&&f.push(`${e.label.toLowerCase()} trims line two to “${o.secondary.slice(0,e.secondary)}”`)}),o.color&&s.length>0&&!s.includes(o.color))){let e=this.store.namingTargets().filter(e=>e.colors&&e.colors.length>0&&!e.colors.includes(o.color));e.length&&f.push(`${o.color} is out of range on ${e.map(e=>e.label.toLowerCase()).join(` + `)}`)}return T`
      ...
      <div class="head">
        <div class="head-row">
          ...
          ${l?T`
                ...
                <button
                  ...
                  style="background:${o.color?U[o.color]:`repeating-linear-gradient(135deg,#fffbf0 0 4px,#e9e0cc 4px 8px)`}"
                  @click=${()=>this.store.toggleColorPicker()}
                ></button>
              `:T`<div class="title">switch ${e.selectedKey} macro</div>`}

          <span class="capacity" style=${n.length>=Y?`background:var(--full-border-bg)`:`background:transparent`}
            >${n.length} / ${Y}</span
          >
          ...
          ${e.colorPickerOpen?T`
                <div class="color-popover">
                  ...
                  <div class="color-grid">
                    ${H.map(([e,t])=>{let n=s.length===0||s.includes(e),r=o.color===e;return T`
                        <button
                          class="color-swatch"
                  ...
                  <div class="text-row">
                    ...
                    ${Ue.map(([e,t])=>{let n=o.textColor===e;return T`
                        <button
                          class="text-opt"
        ...
        <div class="tabs">
          ${B.map(({id:n,label:r})=>{let i=t[e.selectedKey][n].length,a=e.action===n;return T`
              <button
                class="tab"
            ...
            <div class="list">
              ${n.length===0?T`
                  ...
                  `:n.map((e,t)=>{let r=J(e);return T`
                    ...
                    `})}
              ${n.length>=Y?T`<div class="full-notice">stack's full — 8 is the limit. drop one to add another.</div>`:null}
            </div>
          `:null}
    `}};Z([N({attribute:!1})],$.prototype,`store`,void 0),Z([N({type:Boolean,reflect:!0})],$.prototype,`phone`,void 0),Z([N({type:Boolean,reflect:!0})],$.prototype,`desktop`,void 0),$=Z([M(`macro-panel`)],$);function Nt(e,t){let n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function Pt(e,t){let n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}var Ft=class extends j{constructor(...e){super(...e),this.phone=!1}static{this.styles=[P,F,L,I,o`
      .panel {
        width: 880px;
        max-width: 100%;
        max-height: 88vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}handleDownload(){let e=this.store.state,t=Mt.compile(e);t.exportFile.mimeType===`application/json`?Nt(t.exportFile.filename,JSON.parse(t.exportFile.content)):Pt(t.exportFile.filename,t.exportFile.content)}render(){let e=this.store.state;if(!e.compileOpen)return null;let t=this.store.totalAssigned,n=V.getController(e.controllerId),r=V.getBrain(e.brainId),i=e.rig.length?e.rig.map(e=>V.getDevice(e)?.name||e).join(`, `):`no pedals yet`,a=`${t} ${t===1?`message`:`messages`} · ${n.short} → ${r.short} → ${i}`,o=V.getTarget(e.targetId),s=Mt.compile(e),c=s.preview,l=s.diagnostics;return T`
    ...
    `}};Z([N({attribute:!1})],Ft.prototype,`store`,void 0),Z([N({type:Boolean,reflect:!0})],Ft.prototype,`phone`,void 0),Ft=Z([M(`compile-modal`)],Ft);var It=[{id:`photo`,label:`photo`},{id:`drawn`,label:`sketch`}],Lt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 520px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;if(!e.settingsOpen)return null;let t=this.store.ident(e.bank,e.selectedKey),n=this.store.sharedColors(),r=H.map(e=>e[0]).filter(e=>n.length>0&&!n.includes(e)),i=this.store.displayTargets().length>0||n.length>0,a=this.store.namingTargets();return T`
            ...
            ${i?T`
                  <div class="section" style="padding-top:4px;padding-bottom:22px">
                    ...
                    <div class="conventions-container">
                      ${a.map((e,n)=>{let r=this.store.colorFor(e.id,t.color),i=e.name===0?`#f7f1e3`:r?U[r]:`#16323d`,a=e.name===0?`#16323d`:e.text?We[t.textColor]:Ke(i)?`#f7f1e3`:`#16323d`,o=[];e.name?o.push(`${e.name} char${e.secondary?` × 2 lines`:``}`):o.push(`no display`),e.colors===null?o.push(`any colour`):e.colors.length&&o.push(`${e.colors.length} leds`);let s=e.name?t.name.slice(0,e.name):t.name,c=e.secondary>0&&!!t.secondary,l=t.secondary.slice(0,e.secondary);return T`
                          <div
                    ...
                    ${n.length>0?T`
                          <div class="shared-row">
                            ...
                            <div class="swatches-wrap">
                              ${H.map(([e,t])=>{let r=n.includes(e);return T`
                                  <span
                                    class="swatch-item"
    ...
    `}};Z([N({attribute:!1})],Lt.prototype,`store`,void 0),Lt=Z([M(`settings-modal`)],Lt);var Rt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 470px;
        max-width: 100%;
        background: var(--card);
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;return e.controllerPickerOpen?T`
    ...
    `:null}};Z([N({attribute:!1})],Rt.prototype,`store`,void 0),Rt=Z([M(`controller-picker-modal`)],Rt);var zt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 500px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;return e.brainPickerOpen?T`
      <div class="scrim" @click=${e=>e.target===e.currentTarget&&this.store.closeBrainPicker()}>
        <div class="panel sheet-in">
          ...
          <div class="tiles">
            ${Ve.map(t=>{let n=Be[t],r=e.brainId===t,i=n.maxSteps===1?`1 msg`:`up to ${n.maxSteps}`;return T`
    ...
    `:null}};Z([N({attribute:!1})],zt.prototype,`store`,void 0),zt=Z([M(`brain-picker-modal`)],zt);var Bt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 480px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;if(!e.addPedalOpen)return null;let t=Re.filter(t=>!e.rig.includes(t)),n=t.length===0;return T`
      <div class="scrim" @click=${e=>e.target===e.currentTarget&&this.store.closeAddPedal()}>
        <div class="panel sheet-in">
          ...
          <div class="body">
            ${t.map(t=>{let n=V.getDevice(t),r=e.channels[t]||this.store.nextFreeChannel(e.rig,e.channels);return T`
    ...
    `}};Z([N({attribute:!1})],Bt.prototype,`store`,void 0),Bt=Z([M(`add-pedal-modal`)],Bt);var Vt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 420px;
        max-width: 100%;
        background: var(--card);
    ...
    `}};Z([N({attribute:!1})],Vt.prototype,`store`,void 0),Vt=Z([M(`confirm-remove-modal`)],Vt);var Ht=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 540px;
        max-width: 100%;
        max-height: 90vh;
          ...
          <div class="body">
            <div class="rows-box">
              ${t.map(t=>{let n=!!e.conn[t.id],r=e.listening===t.id;return T`
                  <div class="dev-row">
                    <span class="dev-dot" style="background:${n?t.id===`scribble`?`#8fd0e6`:R[t.id]?.accent||`#8fd0e6`:`transparent`}"></span>
                    <div class="dev-info">
                      <div class="dev-top">
                  ...
                  <div class="heard-card" ?ok=${!e.heard.drift}>
                    <div class="heard-head">
                      ...
                      <span class="heard-title">
                        ${e.heard.drift?`that isn't where we expected it`:`${R[e.heard.pedal]?.name||e.heard.pedal} answers where we thought`}
                      </span>
                    </div>
                    <div class="heard-body">
                      ${e.heard.drift?`${R[e.heard.pedal]?.name||e.heard.pedal} sent cc ${e.heard.cc}, but our map puts that control on cc ${e.heard.expect}. the whole map looks shifted by ${e.heard.drift>0?`+`:``}${e.heard.drift} — probably a firmware revision.`:`cc ${e.heard.cc}, exactly where the map says. the rest of the pedal should line up too.`}
                    </div>
    ...
    `}};Z([N({attribute:!1})],Ht.prototype,`store`,void 0),Ht=Z([M(`connect-modal`)],Ht);function Ut(e){return!e||!e.length?`empty`:e.map(e=>{let t=R[e.device],n=t?.controls.find(t=>t.id===e.control);return`${t?t.name:e.device} ${n?n.short||n.label:e.control}`}).join(` → `)}var Wt=class extends j{static{this.styles=[P,F,L,I,o`
      .panel {
        width: 660px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}handleFileSelect(e){let t=e.target.files?.[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target?.result);this.store.loadScribbleFile(t)}catch{alert(`Could not parse JSON configuration file. Please check file format.`)}},n.readAsText(t)}render(){let e=this.store.state;if(!e.readOpen||!e.readData)return null;let t=e.readData,n=!!t.readingHardware,r=`presets on the ${t.from===`scribble`?`scribble relay`:t.from}`,i=`128 slots, ${t.presets.length} carrying something. send any of them to any stack in bank ${String(e.bank+1).padStart(2,`0`)} — nothing changes until you apply.`,a=t.scanned||0,o=t.total||128,s=t.found||0,c=`slot ${a} / ${o}`,l=s?`${s} ${s===1?`preset found so far`:`presets found so far`}`:`listening for the first answer…`,u=Math.min(100,Math.round(100*a/o)),d=(t.filter||``).trim().toLowerCase(),f=t.presets.filter(e=>!d||String(e.n).indexOf(d)===0||e.label.toLowerCase().includes(d)||e.second.toLowerCase().includes(d)||Ut(e.steps).toLowerCase().includes(d)),p=z[e.controllerId]||z.chocolate,ee=p?p.keys:[`A`,`B`,`C`,`D`],m=[{value:``,label:`— leave it —`}];ee.forEach(e=>{B.forEach(t=>{m.push({value:`${e}:${t.id}`,label:`switch ${e} · ${t.label.toLowerCase()}`})})});let h=Object.keys(t.dest).length,te=`${h} ${h===1?`preset heading into a stack`:`presets heading into stacks`}`,ne=h?`pull ${h} in`:`close`;return T`
      <div class="scrim" @click=${e=>e.target===e.currentTarget&&this.store.cancelRead()}>
        ...
        <div class="panel sheet-in">
            ...
            ${f.length===0?T`
                ...
                `:T`
                  <div class="preset-list">
                    ${f.map(n=>{let r=t.dest[n.n]||null,i=`p${String(n.n).padStart(3,`0`)}`,a=n.color&&U[n.color]?U[n.color]:`var(--ink)`,o=n.color&&U[n.color]&&!Ke(U[n.color])?`var(--ink)`:`#fdf3d4`,s=r?`${r.key}:${r.action}`:``,c=r&&e.banks[e.bank]?.[r.key]?.[r.action]?e.banks[e.bank][r.key][r.action]:null,l=r?B.find(e=>e.id===r.action):null,u=l?l.label.toLowerCase():r?.action||``,d=r?c&&c.length?`switch ${r.key} · ${u} already holds ${c.length} ${c.length===1?`message`:`messages`}`:`switch ${r.key} · ${u} is empty`:``;return T`
                        <div class="preset-slot-row" ?assigned=${!!r}>
                          <div class="preset-top">
                            ...
                            <div class="preset-info">
                              ...
                              <span class="preset-steps">${Ut(n.steps)}</span>
                            </div>
                            <select
                              class="dest-select"
                              ?assigned=${!!r}
                            ...
                            >
                              ${m.map(e=>T`<option value="${e.value}">${e.label}</option>`)}
                            </select>
                          </div>
          ...
          <div class="foot">
            <span class="footer-info">${te}</span>
    ...
    `}};Z([N({attribute:!1})],Wt.prototype,`store`,void 0),Wt=Z([M(`read-modal`)],Wt);var Gt=class extends j{static{this.styles=[P,F,I,o`
      :host {
        display: block;
        flex: none;
        border-top: 2.5px solid var(--ink);
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;return e.monitorOn?T`
      <div class="head">
    ...
    `:null}};Z([N({attribute:!1})],Gt.prototype,`store`,void 0),Gt=Z([M(`wire-monitor`)],Gt);var Kt=760,qt=1120,Jt=class extends j{static{this.styles=[P,F,o`
      :host {
        display: block;
        height: 100vh;
      }
    ...
    `}renderHeaderRig(){let e=this.store.state,t=V.getController(e.controllerId),n=V.getBrain(e.brainId),r=e.rig.length<=2?e.rig.map(e=>V.getDevice(e)?.name||e).join(`, `):`${e.rig.slice(0,2).map(e=>V.getDevice(e)?.name||e).join(`, `)} +${e.rig.length-2}`;return this.phone?T`
    ...
    `}};Z([N({type:Boolean,reflect:!0})],Jt.prototype,`phone`,void 0),Z([N({type:Boolean,reflect:!0})],Jt.prototype,`desktop`,void 0),Jt=Z([M(`stomp-app`)],Jt);