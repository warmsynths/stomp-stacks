...
`).map(e=>({text:e||` `}))}},Y=8;function ft(e,t){return e?e.length<=t?e:e.slice(0,t):``}function pt(e){let t=B.getController(e);return{controllerId:e,brainId:`scribble`,banks:W.createBanks(e),bank:0,selectedKey:t.keys[0],action:`press`,browseDevice:ze[0],face:`photo`,popoverControlId:null,compileOpen:!1,settingsOpen:!1,controllerPickerOpen:!1,brainPickerOpen:!1,addPedalOpen:!1,confirmRemovePedal:null,channelPickerOpen:!1,colorPickerOpen:!1,targetId:`scribble`,rig:[`blooper`,`mood`,`elcap`],channels:{blooper:1,mood:2,elcap:3},naming:{},sheetOpen:!1,connectOpen:!1,readOpen:!1,readData:null,conn:{},listening:null,heard:null,offsets:{},monitorOn:!1,log:[],seq:0}}var mt=class extends EventTarget{constructor(...e){super(...e),this.state=pt(`chocolate`)}set(e){this.state={...this.state,...e},this.dispatchEvent(new Event(`change`))}get activeStack(){let{banks:e,bank:t,selectedKey:n,action:r}=this.state;return W.getActiveStack(e,t,n,r)}get totalAssigned(){return W.countTotalAssignedSteps(this.state.banks)}nextFreeChannel(e=this.state.rig,t=this.state.channels){return B.findNextFreeChannel(e,t)}addPedal(e){if(this.state.rig.includes(e)){this.set({addPedalOpen:!1,browseDevice:e});return}let t=[...this.state.rig,e],n={...this.state.channels};n[e]||(n[e]=B.findNextFreeChannel(t.filter(t=>t!==e),n)),this.set({rig:t,channels:n,browseDevice:e,addPedalOpen:!1,popoverControlId:null})}dropPedal(e){if(this.state.rig.length<=1)return;let t=this.state.rig.filter(t=>t!==e),n=this.state.browseDevice===e?t[0]:this.state.browseDevice;this.set({rig:t,browseDevice:n,channelPickerOpen:!1,popoverControlId:null,confirmRemovePedal:null})}setPedalChannel(e,t){let n={...this.state.channels,[e]:t};this.set({channels:n,channelPickerOpen:!1})}toggleChannelPicker(){this.set({channelPickerOpen:!this.state.channelPickerOpen})}setBrain(e){this.set({brainId:e,brainPickerOpen:!1})}openBrainPicker(){this.set({brainPickerOpen:!0,channelPickerOpen:!1})}closeBrainPicker(){this.set({brainPickerOpen:!1})}openAddPedal(){this.set({addPedalOpen:!0,channelPickerOpen:!1})}closeAddPedal(){this.set({addPedalOpen:!1})}setConfirmRemove(e){this.set({confirmRemovePedal:e,channelPickerOpen:!1})}setTarget(e){this.set({targetId:e})}clickControl(e){if(e.type!==`foot`){this.set({popoverControlId:this.state.popoverControlId===e.id?null:e.id,sheetOpen:!0});return}this.addStep(e.id,null)}addStep(e,t){let{banks:n,bank:r,selectedKey:i,action:a,browseDevice:o}=this.state,s=W.addOrToggleStep(n,r,i,a,o,e,t,Y);this.set({banks:s,popoverControlId:null,sheetOpen:!0})}removeStep(e){let{banks:t,bank:n,selectedKey:r,action:i}=this.state,a=W.removeStep(t,n,r,i,e);this.set({banks:a})}moveStep(e,t){let{banks:n,bank:r,selectedKey:i,action:a}=this.state,o=W.moveStep(n,r,i,a,e,t);this.set({banks:o})}selectSwitch(e){this.set({selectedKey:e,popoverControlId:null})}selectBank(e){this.set({bank:e,popoverControlId:null})}selectAction(e){this.set({action:e,popoverControlId:null})}setBrowseDevice(e){this.set({browseDevice:e,popoverControlId:null,channelPickerOpen:!1})}closePopover(){this.set({popoverControlId:null})}setFace(e){this.set({face:e,popoverControlId:null})}openSettings(){this.set({settingsOpen:!0})}closeSettings(){this.set({settingsOpen:!1})}openControllerPicker(){this.set({controllerPickerOpen:!0})}closeControllerPicker(){this.set({controllerPickerOpen:!1})}openCompile(){this.set({compileOpen:!0})}closeCompile(){this.set({compileOpen:!1})}toggleSheet(){this.set({sheetOpen:!this.state.sheetOpen})}setSheet(e){this.set({sheetOpen:e})}toggleColorPicker(){this.set({colorPickerOpen:!this.state.colorPickerOpen})}closeColorPicker(){this.set({colorPickerOpen:!1})}namingTargets(){let e=[this.state.controllerId];return this.state.brainId===`scribble`&&e.push(`scribble`),e.filter(e=>U[e]).map(e=>({...U[e]}))}displayTargets(){return this.namingTargets().filter(e=>e.name>0)}sharedColors(){let e=this.namingTargets().filter(e=>e.colors===null||e.colors.length>0);return e.length?V.map(e=>e[0]).filter(t=>e.every(e=>e.colors===null||e.colors&&e.colors.includes(t))):[]}autoName(e=this.state.bank,t=this.state.selectedKey){let n=this.state.banks[e]?.[t];if(!n)return``;let r=null,i=0;if(z.forEach(e=>n[e.id].forEach(e=>{i++,r||=e})),!r)return``;let a=r,o=B.getDevice(a.device);if(!o)return``;let s=B.getControl(a.device,a.control),c=this.displayTargets().reduce((e,t)=>Math.min(e,t.name),24);return ft(i>1?`${o.name} +${i-1}`:`${o.name} ${s?s.short:``}`,c)}autoSecondary(e=this.state.bank,t=this.state.selectedKey){let n=this.state.banks[e]?.[t];if(!n)return``;let r=[];return z.forEach(e=>{n[e.id].length&&r.push(`${n[e.id].length} on ${e.label}`)}),r.join(` · `)}ident(e=this.state.bank,t=this.state.selectedKey){let n=`${e}:${t}`,r=this.state.naming[n]||{},i=this.autoName(e,t),a=this.autoSecondary(e,t),o=r.color||null,s=o?H[o]:`#16323d`;return{name:r.name!=null&&r.name!==``?r.name:i,secondary:r.secondary||``,color:o,textColor:r.textColor||(qe(s)?`cream`:`ink`),autoText:!r.textColor,raw:r,auto:i,autoSec:a}}setIdent(e,t=this.state.bank,n=this.state.selectedKey){let r=`${t}:${n}`,i={...this.state.naming,[r]:{...this.state.naming[r],...e}};this.set({naming:i})}colorFor(e,t){if(!t)return null;let n=U[e];if(!n)return null;if(n.colors===null)return t;if(!n.colors.length)return null;if(n.colors.includes(t))return t;let r=Ke[t];return r&&n.colors.includes(r)?r:n.colors[0]}switchController(e){let t=B.getController(e);this.set({controllerId:e,banks:W.createBanks(e),bank:0,selectedKey:t.keys[0],controllerPickerOpen:!1,popoverControlId:null,colorPickerOpen:!1})}openConnect(){this.set({connectOpen:!0})}closeConnect(){this.set({connectOpen:!1})}pushLog(e){let t=this.state.seq+1,n={n:t,...e},r=[...this.state.log,n].slice(-60);this.set({seq:t,log:r})}toggleConn(e){let t=!!this.state.conn[e],n={...this.state.conn,[e]:!t},r=t&&this.state.listening===e?null:this.state.listening;this.set({conn:n,listening:r});let i=q.getHardwareNodes(this.state).find(t=>t.id===e);this.pushLog({text:(t?`closed `:`opened `)+(i?i.port:e),sub:i?i.name:e,tone:t?`warn`:`ok`})}stompTest(){let e=this.state,t=e.banks[e.bank]?.[e.selectedKey]?.[e.action]||[],n=z.find(t=>t.id===e.action),r=n?n.label:e.action;if(!t.length){this.pushLog({text:`switch ${e.selectedKey} · ${r}`,sub:`nothing stacked here`,tone:`warn`});return}this.pushLog({text:`▸ switch ${e.selectedKey} · ${r}`,sub:`${t.length} ${t.length===1?`message`:`messages`} out`,tone:`trig`}),t.forEach((t,n)=>{setTimeout(()=>{let n=L[t.device];if(!n)return;let r=n.controls.find(e=>e.id===t.control),i=e.channels[t.device]||1,a=(r?r.cc:10)+(e.offsets[t.device]||0),o=t.value===null?127:t.value,s=!!e.conn[t.device];s&&q.sendControlChange(i,a,o),this.pushLog({text:`${K(176+i-1)} ${K(a)} ${K(o)}`,sub:s?`${n.name} · ${r?r.label:t.control}`:`${n.name} never answered — is it plugged in?`,tone:s?`out`:`warn`})},110*n)})}async readFrom(e,t){let n=this.state,r=R[n.controllerId],i=r?r.keys:[`A`,`B`,`C`,`D`];this.set({readOpen:!0,readData:{from:e,allPresets:[],readingHardware:!t},connectOpen:!1});let a=t;a||=(this.pushLog({text:`querying ${e}...`,sub:`sending Web Serial / MIDI query to device`,tone:`trig`}),await q.readLiveDeviceConfig(e)??void 0);let o=(a?ut(a,n.channels,i):[]).map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0})),s=q.getHardwareNodes(n).find(t=>t.id===e);this.pushLog({text:`read ${s?s.name:e}`,sub:a?`${o.length} device presets loaded live from physical Scribble`:`live hardware query finished — select scribble.json file if USB CDC requires manual grant`,tone:a?`ok`:`warn`}),this.set({readData:{from:e,allPresets:o,readingHardware:!1}})}async readLiveUsbSerial(){this.set({readOpen:!0,readData:{from:`scribble`,allPresets:[],readingHardware:!0}});let e=await q.requestLiveSerialConfig(),t=this.state,n=R[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`],i=(e?ut(e,t.channels,r):[]).map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0}));this.pushLog({text:`read USB device`,sub:e?`${i.length} presets loaded live from physical Scribble`:`no USB serial data received — select scribble.json file`,tone:e?`ok`:`warn`}),this.set({readData:{from:`scribble`,allPresets:i,readingHardware:!1}})}async connectAndImportScribble(){this.pushLog({text:`connecting to Scribble...`,sub:`requesting USB device permission`,tone:`trig`});let e=await q.requestLiveSerialConfig(),t=this.state,n=R[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`];if(e){let n=ut(e,t.channels,r).map((e,t)=>({id:`${e.bankIndex}:${e.key}:${t}`,bankIndex:e.bankIndex,key:e.key,presetName:e.presetName,secondaryText:e.secondaryText,steps:e.steps,selected:!0}));if(n.length>0){this.loadPresetsIntoBanks(n),this.pushLog({text:`Scribble connected & synced`,sub:`imported ${n.length} active hardware presets`,tone:`ok`}),this.set({connectOpen:!1});return}}this.readFrom(`scribble`,e||void 0)}loadScribbleFile(e){this.readFrom(`scribble`,e)}togglePresetSelection(e){if(!this.state.readData)return;let t=this.state.readData.allPresets.map(t=>t.id===e?{...t,selected:!t.selected}:t);this.set({readData:{...this.state.readData,allPresets:t}})}selectAllReadPresets(e){if(!this.state.readData)return;let t=this.state.readData.allPresets.map(t=>({...t,selected:e}));this.set({readData:{...this.state.readData,allPresets:t}})}importSinglePreset(e){let t=this.state,n=t.bank,r=t.selectedKey,i=t.banks.map((t,i)=>{if(i!==n)return t;let a={...t};return a[r]={...a[r],press:[...e.steps]},a}),a=`${n}:${r}`,o={...t.naming,[a]:{name:e.presetName,secondary:e.secondaryText}};this.pushLog({text:`imported preset "${e.presetName}"`,sub:`loaded into Bank ${n+1} - Switch ${r}`,tone:`ok`}),this.set({banks:i,naming:o})}loadPresetsIntoBanks(e){if(!e||!e.length)return;let t=this.state,n=R[t.controllerId],r=n?n.keys:[`A`,`B`,`C`,`D`],i=Math.max(...e.map(e=>e.bankIndex),0),a=Math.max(t.banks.length,i+1),o=[];for(let e=0;e<a;e++){let n={...t.banks[e]||W.createBanks(t.controllerId)[0]};Object.keys(n).forEach(e=>{n[e]={press:[...n[e].press],hold:[...n[e].hold],double:[...n[e].double]}}),o.push(n)}let s={...t.naming};e.forEach(e=>{if(e.bankIndex<o.length&&r.includes(e.key)){o[e.bankIndex][e.key]&&(o[e.bankIndex][e.key].press=[...e.steps]);let t=`${e.bankIndex}:${e.key}`;s[t]={name:e.presetName,secondary:e.secondaryText}}});let c={...t.conn,scribble:!0};this.set({banks:o,naming:s,conn:c,readOpen:!1,readData:null})}importSelectedDevicePresets(){let e=this.state.readData;if(!e||!e.allPresets.length)return;let t=e.allPresets.filter(e=>e.selected);t.length&&(this.loadPresetsIntoBanks(t),this.pushLog({text:`imported ${t.length} presets from Scribble`,sub:`loaded into Stomp Stacks banks & macro stacks`,tone:`ok`}))}pickReadRow(e,t){}applyRead(){this.importSelectedDevicePresets()}cancelRead(){this.set({readOpen:!1,readData:null})}listenTo(e){if(!this.state.conn[e])return;this.set({listening:e,heard:null});let t=L[e];if(!t)return;let n={blooper:4,mood:0,elcap:-2}[e]||0,r=t.controls[2]||t.controls[0],i=r?r.cc:10,a=this.state.offsets[e]||0;setTimeout(()=>{if(this.state.listening!==e)return;let o=i+a+n,s=i+a;this.set({heard:{pedal:e,control:r.id,cc:o,expect:s,drift:n}});let c=this.state.channels[e]||1;this.pushLog({text:`${K(176+c-1)} ${K(o)} 7F`,sub:`${t.name} sent this when you moved ${r.short||r.label}`,tone:`in`})},1100)}acceptDrift(){let e=this.state.heard;if(!e)return;let t=L[e.pedal],n={...this.state.offsets,[e.pedal]:(this.state.offsets[e.pedal]||0)+e.drift};this.set({offsets:n,heard:null,listening:null}),this.pushLog({text:`shifted ${t?t.name:e.pedal} by ${e.drift>0?`+`:``}${e.drift}`,sub:`its whole map moves with it`,tone:`ok`})}dismissHeard(){this.set({heard:null,listening:null})}toggleMonitor(){this.set({monitorOn:!this.state.monitorOn})}clearLog(){this.set({log:[]})}},X=class{constructor(e,t){this.onChange=()=>this.host.requestUpdate(),this.host=e,this.store=t,e.addController(this)}hostConnected(){this.store.addEventListener(`change`,this.onChange)}hostDisconnected(){this.store.removeEventListener(`change`,this.onChange)}};function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var ht=class extends A{constructor(...e){super(...e),this.desktop=!1}static{this.styles=[N,P,o`
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=R[e.controllerId],n=e.banks[e.bank],r=this.desktop?t.heightDesktop:t.height;return w`
    ...
    `}};Z([M({attribute:!1})],ht.prototype,`store`,void 0),Z([M({type:Boolean,reflect:!0})],ht.prototype,`desktop`,void 0),ht=Z([j(`controller-graphic`)],ht);var gt=class extends A{static{this.styles=[N,P,F,o`
      :host {
        display: block;
        position: relative;
        overflow: visible;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=e.browseDevice,n=B.getDevice(t),r=e.channels[t]||(n?n.midiChannel:1);return w`
      <div class="wrap">
        <div class="row">
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state,t=B.getDevice(e.browseDevice),n=e.face===`drawn`,r=this.store.activeStack,i={aspectRatio:n?`344/426`:`${t.pw}/${t.ph}`,width:this.phone?`100%`:`auto`,maxWidth:`100%`,height:this.phone?`auto`:`100%`};return this.desktop&&(i.maxHeight=n?`420px`:`600px`),w`
      <div class="canvas">
        ${this.desktop?w`
...
`)}}compilePreview(e){let t=[],n=(e,n)=>{t.push({text:e===``?` `:e,...n})};return ot(e,(t,r,i,a,o)=>{n(`▸ bank ${t+1} · ${r} ${a.label}`,{bold:!0}),o.forEach(t=>{let r=J(t,e.channels);n(`    ${Ot(176+r.channel-1)} ${Ot(r.cc)} ${Ot(r.value)}    ${r.deviceName} ${r.label}`,{muted:!0})}),n(``)}),t.length||n(`nothing stacked yet — go poke a pedal`,{muted:!0}),t}},At={rig:new Et,mc3:new at,scribble:new dt,labels:new Dt,trace:new kt};function jt(e){let t=B.getBrain(e.brainId),n=B.getController(e.controllerId),r=[],i=0,a=0;ot(e,(e,n,r,o,s)=>{s.length>t.maxSteps&&(i++,s.length>a&&(a=s.length))}),i&&r.push({type:`warn`,text:`${i} stack${i===1?``:`s`} run to ${a} messages — ${t.full.toLowerCase()} sends ${t.maxSteps}${e.brainId===`none`?`. this is the case for a brain.`:`. trim them or move up.`}`}),e.banks.length>t.banks&&r.push({type:`warn`,text:`${n.name} has ${e.banks.length} banks; ${t.full.toLowerCase()} holds ${t.banks}.`}),e.brainId===`onboard`&&!n.onboard&&r.push({type:`warn`,text:`${n.name} can't hold stacks onboard — it only sends one message per switch.`});let o=Ct(e).filter(t=>!e.rig.includes(t));o.length&&r.push({type:`warn`,text:`${o.map(e=>B.getDevice(e)?.name||e).join(` + `)} ${o.length===1?`is`:`are`} stacked but no longer in the rig — those steps won't be sent.`}),B.detectChannelCollisions(e.rig,e.channels).forEach(({channel:e,devices:t})=>{r.push({type:`warn`,text:`${t.join(` + `)} are both on channel ${e} — their cc numbers will collide.`})}),e.targetId===`mc3`&&e.controllerId!==`mc3`&&r.push({type:`warn`,text:`building an mc3 preset, but the rig is set to ${n.name}.`}),e.targetId===`scribble`&&e.brainId!==`scribble`&&r.push({type:`warn`,text:`building a scribble config, but the brain is set to ${t.full.toLowerCase()}.`});let s={state:e,namingTargets(){let t=[e.controllerId];return e.brainId===`scribble`&&t.push(`scribble`),t.filter(e=>U[e]).map(e=>({...U[e]}))},displayTargets(){return this.namingTargets().filter(e=>e.name>0)},sharedColors(){let e=this.namingTargets().filter(e=>e.colors===null||e.colors.length>0);return e.length?V.map(e=>e[0]).filter(t=>e.every(e=>e.colors===null||e.colors&&e.colors.includes(t))):[]}},c=[];e.banks.forEach((t,n)=>{Object.keys(t).forEach(r=>{let i=0;if(z.forEach(e=>{i+=t[r][e.id].length}),i){let t=`${n}:${r}`,i=e.naming&&e.naming[t]||{};c.push({name:i.name||``,secondary:i.secondary||``,color:i.color||null,raw:i})}})}),s.displayTargets().forEach(e=>{let t=c.filter(t=>t.raw.name&&t.name.length>e.name).length;if(t&&r.push({type:`warn`,text:`${t} ${t===1?`name is`:`names are`} longer than the ${e.label.toLowerCase()} shows (${e.name} characters) — ${t===1?`it reads`:`they read`} trimmed there.`}),!e.secondary){let t=c.filter(e=>e.secondary).length;t&&r.push({type:`warn`,text:`${t} second ${t===1?`line has`:`lines have`} nowhere to go on the ${e.label.toLowerCase()} — ${t===1?`it lands`:`they land`} on the label sheet instead.`})}});let l=s.sharedColors(),u={};return c.forEach(e=>{e.color&&(!l.length||!l.includes(e.color))&&(u[e.color]=!0)}),Object.keys(u).forEach(e=>{let t=e,n=s.namingTargets().filter(e=>e.colors&&e.colors.length&&!e.colors.includes(t));n.length&&r.push({type:`warn`,text:`${e} isn't in ${n.map(e=>e.label.toLowerCase()).join(` or `)}'s palette — those stacks fall back to a compatible color there.`})}),r.length||r.push({type:`ok`,text:`all clear — nothing collides, nothing overflows.`}),r}var Mt=class{static compile(e,t=e.targetId){let n=At[t]||At.rig;return{targetId:t,exportFile:n.compileExport(e),preview:n.compilePreview(e),diagnostics:jt(e)}}static getAdapter(e){return At[e]||At.rig}};Mt.compile;var $=class extends A{constructor(...e){super(...e),this.phone=!1,this.desktop=!1}static{this.styles=[N,P,F,o`
            ...
            <div class="list">
              ${n.length===0?w`
                  ...
                  `:n.map((e,t)=>{let r=J(e);return w`
                    ...
                    `})}
              ${n.length>=Y?w`<div class="full-notice">stack's full — 8 is the limit. drop one to add another.</div>`:null}
            </div>
          `:null}
    `}};Z([M({attribute:!1})],$.prototype,`store`,void 0),Z([M({type:Boolean,reflect:!0})],$.prototype,`phone`,void 0),Z([M({type:Boolean,reflect:!0})],$.prototype,`desktop`,void 0),$=Z([j(`macro-panel`)],$);function Nt(e,t){let n=new Blob([JSON.stringify(t,null,2)],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}function Pt(e,t){let n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}var Ft=class extends A{constructor(...e){super(...e),this.phone=!1}static{this.styles=[N,P,I,F,o`
      .panel {
        width: 880px;
        max-width: 100%;
        max-height: 88vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}handleDownload(){let e=this.store.state,t=Mt.compile(e);t.exportFile.mimeType===`application/json`?Nt(t.exportFile.filename,JSON.parse(t.exportFile.content)):Pt(t.exportFile.filename,t.exportFile.content)}render(){let e=this.store.state;if(!e.compileOpen)return null;let t=this.store.totalAssigned,n=B.getController(e.controllerId),r=B.getBrain(e.brainId),i=e.rig.length?e.rig.map(e=>B.getDevice(e)?.name||e).join(`, `):`no pedals yet`,a=`${t} ${t===1?`message`:`messages`} · ${n.short} → ${r.short} → ${i}`,o=B.getTarget(e.targetId),s=Mt.compile(e),c=s.preview,l=s.diagnostics;return w`
    ...
    `}};Z([M({attribute:!1})],Ft.prototype,`store`,void 0),Z([M({type:Boolean,reflect:!0})],Ft.prototype,`phone`,void 0),Ft=Z([j(`compile-modal`)],Ft);var It=[{id:`photo`,label:`photo`},{id:`drawn`,label:`sketch`}],Lt=class extends A{static{this.styles=[N,P,I,F,o`
      .panel {
        width: 520px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `}};Z([M({attribute:!1})],Lt.prototype,`store`,void 0),Lt=Z([j(`settings-modal`)],Lt);var Rt=class extends A{static{this.styles=[N,P,I,F,o`
      .panel {
        width: 470px;
        max-width: 100%;
        background: var(--card);
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;return e.controllerPickerOpen?w`
    ...
    `:null}};Z([M({attribute:!1})],Rt.prototype,`store`,void 0),Rt=Z([j(`controller-picker-modal`)],Rt);var zt=class extends A{static{this.styles=[N,P,I,F,o`
      .panel {
        width: 500px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;return e.brainPickerOpen?w`
    ...
    `:null}};Z([M({attribute:!1})],zt.prototype,`store`,void 0),zt=Z([j(`brain-picker-modal`)],zt);var Bt=class extends A{static{this.styles=[N,P,I,F,o`
      .panel {
        width: 480px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;if(!e.addPedalOpen)return null;let t=ze.filter(t=>!e.rig.includes(t)),n=t.length===0;return w`
    ...
    `}};Z([M({attribute:!1})],Bt.prototype,`store`,void 0),Bt=Z([j(`add-pedal-modal`)],Bt);var Vt=class extends A{static{this.styles=[N,P,I,F,o`
      .panel {
        width: 420px;
        max-width: 100%;
        background: var(--card);
    ...
    `}};Z([M({attribute:!1})],Vt.prototype,`store`,void 0),Vt=Z([j(`confirm-remove-modal`)],Vt);var Ht=class extends A{static{this.styles=[N,P,I,F,o`
      .panel {
        width: 540px;
        max-width: 100%;
        max-height: 90vh;
      ...
      <div class="scrim" @click=${e=>e.target===e.currentTarget&&this.store.closeConnect()}>
        ...
        <div class="panel sheet-in">
          <div class="head">
            ...
            <div class="meta">${`${t.filter(t=>e.conn[t.id]).length} connected · ${t.length} available ports`}</div>
          </div>
          <div class="body">
            <div class="rows-box">
              ${t.map(t=>{let n=!!e.conn[t.id];return w`
                  <div class="dev-row">
                    <span class="dev-dot" style="background:${e.listening===t.id?`var(--sky)`:n?`#5bb85b`:`rgba(22,50,61,.3)`}"></span>
                    <div class="dev-info">
                      <div class="dev-top">
                        <span class="dev-name">${t.name}</span>
                        <span class="dev-kind">${t.kind}</span>
                      </div>
                      <span class="dev-port">${t.port}</span>
                    </div>
                    ${t.id===`scribble`?w`
                          <button
                            class="btn-action"
                            style="background:${n?`#e1f4e1`:`var(--mustard)`};"
                            @click=${()=>this.store.connectAndImportScribble()}
                          >
                            ${n?`✓ Synced`:`Connect & Sync`}
                          </button>
                        `:w`
                          <button
                            class="btn-toggle"
                            style="background:${n?`#ffe6dd`:`transparent`};opacity:${n?1:.6}"
            ...
            ${e.heard?w`
                  <div class="heard-card">
                    ...
                    <div class="heard-body">
                      ${L[e.heard.pedal]?.name||e.heard.pedal} sent ${K(e.heard.cc)} when you moved
                      ${L[e.heard.pedal]?.controls.find(t=>t.id===e.heard?.control)?.short||e.heard.control}. Expected
                      ${K(e.heard.expect)} (diff ${e.heard.drift>0?`+`:``}${e.heard.drift}). Shift the map to align?
                    </div>
                    <div class="heard-btns">
                      <button class="btn-accept" @click=${()=>this.store.acceptDrift()}>
                        accept drift (${e.heard.drift>0?`+`:``}${e.heard.drift})
                      </button>
    ...
    `}};Z([M({attribute:!1})],Ht.prototype,`store`,void 0),Ht=Z([j(`connect-modal`)],Ht);function Ut(e){return!e||!e.length?`empty (no MIDI messages assigned)`:e.map(e=>{let t=L[e.device],n=t?.controls.find(t=>t.id===e.control);return`${t?t.name:e.device} ${n?n.short||n.label:e.control}${e.value===null?``:` (${e.value})`}`}).join(` → `)}var Wt=class extends A{static{this.styles=[N,P,I,F,o`
      .panel {
        width: 740px;
        max-width: 100%;
        max-height: 90vh;
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}handleFileSelect(e){let t=e.target.files?.[0];if(!t)return;let n=new FileReader;n.onload=e=>{try{let t=JSON.parse(e.target?.result);this.store.loadScribbleFile(t)}catch{alert(`Could not parse JSON configuration file. Please check file format.`)}},n.readAsText(t)}triggerFileInput(){let e=this.shadowRoot?.querySelector(`#read-file-input`);e&&e.click()}render(){let e=this.store.state;if(!e.readOpen||!e.readData)return null;let{from:t,allPresets:n}=e.readData,r=t===`scribble`?`Scribble`:t.toUpperCase(),i=n.filter(e=>e.selected);return w`
      <div class="scrim" @click=${e=>e.target===e.currentTarget&&this.store.cancelRead()}>
        ...
        <div class="panel sheet-in">
          <div class="head">
            <div class="title">read config from ${r}</div>
            <div class="meta">
          ...
          <div class="body">
            <div class="top-bar">
              ...
              <button class="btn-select-all" @click=${()=>this.store.selectAllReadPresets(!0)}>
                ✓ select all
              </button>
              <button class="btn-select-all" @click=${()=>this.store.selectAllReadPresets(!1)}>
                deselect all
              </button>
              <span class="selection-count">
                ${i.length} of ${n.length} selected
              </span>
            </div>

            ${e.readData.readingHardware?w`
                  ...
                  <div class="preset-list">
                    ${n.map(e=>w`
                        <div
                          class="preset-row"
                          ?selected=${e.selected}
                          @click=${()=>this.store.togglePresetSelection(e.id)}
                        >
                          <input
                            type="checkbox"
                            ...
                            @change=${()=>this.store.togglePresetSelection(e.id)}
                          />
                          <span class="preset-tag">Preset ${e.bankIndex*4+(e.key===`A`?1:e.key===`B`?2:e.key===`C`?3:4)} · ${e.key}</span>
                          <div class="preset-info">
                            <div class="preset-title">${e.presetName}</div>
                            ${e.secondaryText?w`<div class="preset-sub">${e.secondaryText}</div>`:null}
                            <div class="preset-steps">${Ut(e.steps)}</div>
                          </div>
                        </div>
                      `)}
                  </div>
          ...
          <div class="foot">
            ...
            >
              load ${i.length} selected ${i.length===1?`preset`:`presets`} into app
            </button>
          </div>
        </div>
      </div>
    `}};Z([M({attribute:!1})],Wt.prototype,`store`,void 0),Wt=Z([j(`read-modal`)],Wt);var Gt=class extends A{static{this.styles=[N,P,F,o`
      :host {
        display: block;
        flex: none;
        border-top: 2.5px solid var(--ink);
    ...
    `]}connectedCallback(){super.connectedCallback(),this.storeController??=new X(this,this.store)}render(){let e=this.store.state;return e.monitorOn?w`
      <div class="head">
      ...
      <div class="log-area">
        ${e.log.length===0?w`<div class="empty-note">quiet on the wire — stomp something</div>`:e.log.map(e=>w`
                <div class="log-row">
    ...
    `:null}};Z([M({attribute:!1})],Gt.prototype,`store`,void 0),Gt=Z([j(`wire-monitor`)],Gt);var Kt=760,qt=1120,Jt=class extends A{static{this.styles=[N,P,o`
      :host {
        display: block;
        height: 100vh;
      }
    ...
    `]}constructor(){super(),this.store=new mt,this.phone=window.innerWidth<Kt,this.desktop=window.innerWidth>=qt,this.onResize=()=>{this.phone=window.innerWidth<Kt,this.desktop=window.innerWidth>=qt},new X(this,this.store)}connectedCallback(){super.connectedCallback(),window.addEventListener(`resize`,this.onResize)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener(`resize`,this.onResize)}render(){let e=this.store.totalAssigned,t=this.store.state,n=Object.keys(t.conn).filter(e=>t.conn[e]).length;return w`
      <div class="root">
        <header>
          <div class="brand">
    ...
    `}};Z([M({type:Boolean,reflect:!0})],Jt.prototype,`phone`,void 0),Z([M({type:Boolean,reflect:!0})],Jt.prototype,`desktop`,void 0),Jt=Z([j(`stomp-app`)],Jt);